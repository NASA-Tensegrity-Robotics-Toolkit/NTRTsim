...
SingleRodModel::SingleRodModel() : tgModel() 
{
}

SingleRodModel::~SingleRodModel()
{
}

void SingleRodModel::addNodes(tgStructure& s)
{
...
void SingleRodModel::addRods(tgStructure& s)
{
    s.addPair( 0,  1, "rod");
}

void SingleRodModel::addActuators(tgStructure& s)
{

}

void SingleRodModel::setup(tgWorld& world)
{
...
void SingleRodModel::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void SingleRodModel::onVisit(tgModelVisitor& r)
{
    tgModel::onVisit(r);
}

const std::vector<tgBasicActuator*>& SingleRodModel::getAllActuators() const
{
    return allActuators;
}
    
void SingleRodModel::teardown()
{
    notifyTeardown();
    tgModel::teardown();
}
