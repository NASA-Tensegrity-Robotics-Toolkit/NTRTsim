...
/**
 * @file PrismModelML.cpp
 * @brief Contains the definition of the members of the class PrismModelML.
 * $Id$
 */

// This module
#include "PrismModelML.h"
// This library
...
void PrismModelML::addNodes(tgStructure& s,
                            double edge,
                            double width,
                            double height)
{
...
void PrismModelML::addRods(tgStructure& s)
{
    s.addPair( 0,  4, "rod");
    s.addPair( 1,  5, "rod");
    s.addPair( 2,  3, "rod");
...
void PrismModelML::addMuscles(tgStructure& s)
{
    // Bottom Triangle
...
void PrismModelML::setup(tgWorld& world)
{
...
void PrismModelML::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void PrismModelML::onVisit(tgModelVisitor& r)
{
    // Example: m_rod->getRigidBody()->dosomething()...
    tgModel::onVisit(r);
}

const std::vector<tgSpringCableActuator*>& PrismModelML::getAllActuators() const
{
    return allActuators;
}
    
void PrismModelML::teardown()
{
    notifyTeardown();
    tgModel::teardown();
}
