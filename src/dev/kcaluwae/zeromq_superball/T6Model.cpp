...
void T6Model::setup(tgWorld& world)
{
    ...
    tgBasicActuator::Config actuatedCableConfig(3100., c.damping, c.pretension, c.hist, 
    ...
    spec.addBuilder("actuated", new tgBasicContactCableInfo(actuatedCableConfig));
