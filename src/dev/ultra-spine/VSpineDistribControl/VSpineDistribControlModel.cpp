...
/**
 * @file VSpineDistribControlModel.cpp
 * @brief Contains the implementation of class VSpineDistribControlModel
 * @author Andrew P. Sabelhaus and Ankita Joshi
 * $Id$
 */
...
VSpineDistribControlModel::VSpineDistribControlModel(size_t segments) :
    m_segments(segments),
    tgModel() 
{
}
...
void VSpineDistribControlModel::trace(const tgStructureInfo& structureInfo, tgModel& model)
{
 ...
 */
void VSpineDistribControlModel::trace(const tgStructure& structure,
			    const tgStructureInfo& structureInfo, tgModel& model)
{
    std::cout << std::endl << "Structure Trace inside VSpineDistribControlModel:" << std::endl
    << structure        << std::endl 
    << std::endl << "StructureInfo Trace inside VSpineDistribControlModel:" << std::endl
    << structureInfo    << std::endl
    << std::endl << "tgModel Trace inside VSpineDistribControlModel: " << std::endl
    << model            << std::endl;
}


void VSpineDistribControlModel::addNodes(tgStructure& vertebra, ConfigVertebra& conf_vertebra)
{
    // right
...
double VSpineDistribControlModel::getDensity(ConfigVertebra& conf_vertebra)
{
...
double VSpineDistribControlModel::getEdgeLength(ConfigVertebra& conf_vertebra)
{
  // Do we want an assert here?
...
void VSpineDistribControlModel::addRodPairs(tgStructure& vertebra, ConfigVertebra& conf_vertebra)
{
...
void VSpineDistribControlModel::addSegments(tgStructure& spine, const tgStructure& vertebra, 
...
void VSpineDistribControlModel::addVertebra(tgStructure& spine,
...
void VSpineDistribControlModel::addMuscles(tgStructure& spine)
{
...
void VSpineDistribControlModel::mapMuscles(VSpineDistribControlModel::MuscleMap& muscleMap,
 ...
 **************************************/
void VSpineDistribControlModel::setup(tgWorld& world)
{
...
void VSpineDistribControlModel::step(double dt)
{
    if (dt < 0.0)
    {
...
VSpineDistribControlModel::getMuscles (const std::string& key) const
{
...
const std::vector<tgSpringCableActuator*>& VSpineDistribControlModel::getAllMuscles() const
{
    return allMuscles;
}
