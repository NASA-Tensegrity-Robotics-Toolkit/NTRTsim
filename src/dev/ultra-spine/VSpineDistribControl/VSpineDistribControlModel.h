...
/**
 * @file VSpineDistribControlModel.h
 * @brief Contains the definition of class VSpineDistribControlModel
...
class VSpineDistribControlModel : public tgSubject<VSpineDistribControlModel>, public tgModel
{
public: 
     ...
     */
    VSpineDistribControlModel (size_t segments);
	
    /**
     * Nothing to do. Most functions already handled by tgModel::teardown
     */
    virtual ~VSpineDistribControlModel()
    {}
...
private:
     ...
     */
    static void mapMuscles(VSpineDistribControlModel::MuscleMap& muscleMap, tgModel&
