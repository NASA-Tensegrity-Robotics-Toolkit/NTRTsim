...
%One option would be to scale length of rod, $l$, motivated by looking at $\Pi_2$, and then also the angular damping constant, $c_\theta$, in order to make $\Pi_3$ come out to 1 as a result.
