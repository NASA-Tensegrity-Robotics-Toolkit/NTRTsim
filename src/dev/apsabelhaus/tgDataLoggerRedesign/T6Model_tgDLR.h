...
#ifndef T6_MODEL_TGDLR_H
#define T6_MODEL_TGDLR_H

/**
 * @file T6Model_tgDLR.h
 * @brief Contains the definition of class T6Model for the data logger redesign
 * $Id$
 */
 ...
 */
class T6Model_tgDLR : public tgSubject<T6Model_tgDLR>, public tgModel
{
public: 
