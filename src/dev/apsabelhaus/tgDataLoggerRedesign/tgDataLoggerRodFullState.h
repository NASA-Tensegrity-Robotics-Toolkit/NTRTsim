...
#ifndef TG_DATA_LOGGER_ROD_FULLSTATE_H
#define TG_DATA_LOGGER_ROD_FULLSTATE_H

/**
 * @file tgDataLoggerRodFullState.h
 * @brief Contains the definition of class tgDataLoggerRodFullState
 ...
 */
class tgDataLoggerRodFullState : public tgDataLogger_tgDLR {
    
public:

    /* This constructor is for passing in the filename after construction.
     *
     */
    tgDataLoggerRodFullState();
    
    /** Virtual base classes must have a virtual destructor. */
    virtual ~tgDataLoggerRodFullState();
