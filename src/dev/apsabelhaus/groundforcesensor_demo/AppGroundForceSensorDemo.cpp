...
/**
 * @file AppGroundForceSensorDemo.cpp
 * @brief Contains the definition function main() for the demo of the 
 * ground contact force sensor application.
...
{
    std::cout << "AppGroundForceSensorDemo" << std::endl;
    ...
    //tgModel* const myModel = new TwoRodsModel();
