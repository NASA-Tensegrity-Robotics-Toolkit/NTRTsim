...
#ifndef TWO_RODS_MODEL_H
#define TWO_RODS_MODEL_H

/**
 * @file TwoRodsModel.h
 * @brief Contains the definition of class TwoRodsModel.
...
/**
 * This model has two rods, bound at one end by a tgCompressionSpringActuator
 * It's a proof-of-concept test, very simple.
 */
class TwoRodsModel : public tgSubject<TwoRodsModel>, public tgModel
{
public: 
