...
cordeConcaveCollisionAlgorithm::cordeConcaveCollisionAlgorithm( const btCollisionAlgorithmConstructionInfo& ci, const btCollisionObjectWrapper* body0Wrap,const btCollisionObjectWrapper* body1Wrap,bool isSwapped)
: btCollisionAlgorithm(ci),
m_isSwapped(isSwapped),
m_cordeTriangleCallback(ci.m_dispatcher1,body0Wrap,body1Wrap,isSwapped)
{
}



cordeConcaveCollisionAlgorithm::~cordeConcaveCollisionAlgorithm()
{
}



cordeTriangleCallback::cordeTriangleCallback(btDispatcher*  dispatcher,const btCollisionObjectWrapper* body0Wrap,const btCollisionObjectWrapper* body1Wrap,bool isSwapped):
...
cordeTriangleCallback::~cordeTriangleCallback()
{
	clearCache();
...
void	cordeTriangleCallback::clearCache()
{
...
void cordeTriangleCallback::processTriangle(btVector3* triangle,int partId, int triangleIndex)
{
...
void	cordeTriangleCallback::setTimeStepAndCounters(btScalar collisionMarginTriangle,const btCollisionObjectWrapper* triBodyWrap, const btDispatcherInfo& dispatchInfo,btManifoldResult* resultOut)
{
...
void cordeConcaveCollisionAlgorithm::clearCache()
{
	m_cordeTriangleCallback.clearCache();

}

void cordeConcaveCollisionAlgorithm::processCollision (const btCollisionObjectWrapper* body0Wrap,const btCollisionObjectWrapper* body1Wrap,const btDispatcherInfo& dispatchInfo,btManifoldResult* resultOut)
{
	...
	if (triBody->getCollisionShape()->isConcave())
	{
		...
		//	if (convexBody->getCollisionShape()->isConvex())
		{
			...
			m_cordeTriangleCallback.setTimeStepAndCounters(collisionMarginTriangle,triBody,dispatchInfo,resultOut);

		
			concaveShape->processAllTriangles( &m_cordeTriangleCallback,m_cordeTriangleCallback.getAabbMin(),m_cordeTriangleCallback.getAabbMax());
...
btScalar cordeConcaveCollisionAlgorithm::calculateTimeOfImpact(btCollisionObject* body0,btCollisionObject* body1,const btDispatcherInfo& dispatchInfo,btManifoldResult* resultOut)
{
	(void)resultOut;
	(void)dispatchInfo;
	btCollisionObject* convexbody = m_isSwapped ? body1 : body0;
