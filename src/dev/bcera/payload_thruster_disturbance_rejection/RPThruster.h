...
public:
  ...
  double* matrixMultiply(double* a, int num_a_row, int num_a_col, double* b, int num_b_row, int num_b_col);

  double* matrixConcatLeftRight(double* a, int num_a_row, int num_a_col, double* b, int num_b_row, int num_b_col);

  double* matrixConcatTopBottom(double* a, int num_a_row, int num_a_col, double* b, int num_b_row, int num_b_col);

  double* matrixAdd(double* a, int num_a_row, int num_a_col, double* b, int num_b_row, int num_b_col);

  double* matrixSubtract(double* a, int num_a_row, int num_a_col, double* b, int num_b_row, int num_b_col);

  void matrixDimensionCheck(double* a, int num_a_row, int num_a_col);

  void matrixPrint(double a[], int num_a_row, int num_a_col);
