  ...
  tgModel() 
{
  ...
  this->goalAltitude = -20;
  this->goalYaw = 45;
  this->goalVector.setX(sin(goalYaw*M_PI/180));
  this->goalVector.setY(cos((goalAltitude+90)*M_PI/180));
  this->goalVector.setZ(cos(goalYaw*M_PI/180));
