...
*/
/**
* @file AppSaddleArm.cpp
* @brief Contains the definition function main() for the tensegrity arm based upon the designs of Graham Scarr, but now with the addition of a saddle based shoulder.
* application.
* $Id$
*/
// This application
