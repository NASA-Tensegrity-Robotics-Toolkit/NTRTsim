...
/**
 * @file SaddleArmController.cpp
 * @brief Preferred Length Controller for SaddleArmModel
 * @author Erik Jung
 * @version 1.0.0
 * $Id$
 */
...
SaddleArmController::SaddleArmController(const double initialLength, double timestep) :
    m_initialLengths(initialLength),
    m_totalTime(0.0),
    dt(timestep) {}

//Fetch all the muscles and set their preferred length
void SaddleArmController::onSetup(SaddleArmModel& subject) {
...
/*
    for (size_t i=0; i<deltoid.size(); i++) {
		tgBasicActuator * const pMuscle = deltoid[i];
		assert(pMuscle != NULL);
...
void SaddleArmController::onStep(SaddleArmModel& subject, double dt) {
...
void SaddleArmController::setBrachioradialisTargetLength(SaddleArmModel& subject, double dt) {
...
void SaddleArmController::setAnconeusTargetLength(SaddleArmModel& subject, double dt) {
...
void SaddleArmController::moveAllMotors(SaddleArmModel& subject, double dt) {
...
void SaddleArmController::updateActions(SaddleArmModel& subject, double dt) {
...
vector< vector <double> > SaddleArmController::transformActions(vector< vector <double> > actions)
{
	double min=6;
	double max=11;
...
void SaddleArmController::applyActions(SaddleArmModel& subject, vector< vector <double> > act)
{
