...
*/
#ifndef SADDLEARM_MODEL_H
#define SADDLEARM_MODEL_H
/**
* @file SaddleArmModel.h
* @brief Contains the definition of class SaddleArmModel.
* $Id$
*/
// This library
...
*/
class SaddleArmModel : public tgSubject<SaddleArmModel>, public tgModel
{
public:
/**
