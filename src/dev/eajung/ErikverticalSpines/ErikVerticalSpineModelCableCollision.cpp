...
/**
 * @file ErikVerticalSpineModel.cpp
 * @brief Contains the implementation of class ErikVerticalSpineModel
 * @author Brian Tietz, Drew Sabelhaus, Michael Fanton, ChanWoo Yang
 * $Id$
 */

// This module
#include "ErikVerticalSpineModelCableCollision.h"
// This library
...
//m_segments(segments),
//tgModel()
ErikVerticalSpineModelCableCollision::ErikVerticalSpineModelCableCollision(size_t segments) :
    BaseSpineModelLearning(segments)
{
}

ErikVerticalSpineModelCableCollision::~ErikVerticalSpineModelCableCollision()
{
}
/**
...
namespace
{
  ...
  void mapMuscles(ErikVerticalSpineModelCableCollision::MuscleMap& muscleMap,
 ...
 **************************************/
void ErikVerticalSpineModelCableCollision::setup(tgWorld& world)
{
...
void ErikVerticalSpineModelCableCollision::teardown()
{
  BaseSpineModelLearning::teardown();
}

void ErikVerticalSpineModelCableCollision::step(double dt)
{
    if (dt < 0.0)
    {
...
ErikVerticalSpineModel::getMuscles (const std::string& key) const
{
...
const std::vector<tgSpringCableActuator*>& ErikVerticalSpineModel::getAllMuscles() const
{
    return allMuscles;
}
