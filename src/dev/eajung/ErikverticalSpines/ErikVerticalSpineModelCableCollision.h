...
#ifndef ErikVertical_SPINE_MODEL_CABLE_COLLISION_H
#define ErikVertical_SPINE_MODEL_CABLE_COLLISION_H

/**
 * @file ErikVerticalSpineModelCableCollision.h
 * @brief Contains the definition of class ErikVerticalSpineModel
...
class ErikVerticalSpineModelCableCollision: public BaseSpineModelLearning
{
public:

  ErikVerticalSpineModelCableCollision(size_t segments);
  virtual ~ErikVerticalSpineModelCableCollision();
...
/* class ErikVerticalSpineModel: public tgSubject<ErikVerticalSpineModel>, public tgModel */
/* { */
/* public:  */
...
/* 	 *\/ */
/*     ErikVerticalSpineModel(size_t segments); */
	
/* 	/\** */
/* 	 * Nothing to do. Most functions already handled by tgModel::teardown */
/* 	 *\/ */
/*     virtual ~ErikVerticalSpineModel() */
/*     {} */
...
/*      *\/ */
/*     static void mapMuscles(ErikVerticalSpineModel::MuscleMap& muscleMap, tgModel& */
