...
#ifndef ErikVertical_SPINE_RESTLENGTH_CONTROLLER_H
#define ErikVertical_SPINE_RESTLENGTH_CONTROLLER_H

/**
 * @file ErikVerticalSpineRestLengthController.h
 * @brief Contains the definition of class ErikVerticalSpineRestLengthController.
 ...
 */
class ErikVerticalSpineRestLengthController : public tgObserver<ErikVerticalSpineModel>
{
public:
	
  /**
   * Construct a ErikVerticalSpineRestLengthController.
  ...
  ErikVerticalSpineRestLengthController();
    
  /**
   * Nothing to delete, destructor must be virtual
   */
  virtual ~ErikVerticalSpineRestLengthController() { }
   ...
   */
  virtual void onSetup(ErikVerticalSpineModel& subject);
   ...
   */
  virtual void onStep(ErikVerticalSpineModel& subject, double dt);
