...
#ifndef UPPERLIMBTRIANGLE_MODEL_H
#define UPPERLIMBTRIANGLE_MODEL_H

/**
 * @file UpperLimbTriangleModel.h
 * @brief Contains the definition of class UpperLimbTriangleModel.
 * $Id$
 */
 ...
 */
class UpperLimbTriangleModel : public tgSubject<UpperLimbTriangleModel>, public tgModel
{
public: 
     ...
     */
    virtual ~UpperLimbTriangleModel();
...
#endif  // UPPERLIMBTRIANGLE_MODEL_H
