...
/**
 * @file UpperLimbTriangleController.cpp
 * @brief Preferred Length Controller for UpperLimbTriangleModel
...
// This module
#include "UpperLimbTriangleController.h"
// This application
...
void UpperLimbTriangleController::onStep(UpperLimbTriangleModel& subject, double dt) {
...
void UpperLimbTriangleController::setAnconeusTargetLength(UpperLimbTriangleModel& subject, double dt) {
...
void UpperLimbTriangleController::moveAllMotors(UpperLimbTriangleModel& subject, double dt) {
...
void UpperLimbTriangleController::updateActions(UpperLimbTriangleModel& subject, double dt) {
...
vector< vector <double> > UpperLimbTriangleController::transformActions(vector< vector <double> > actions)
{
	double min=6;
	double max=11;
...
void UpperLimbTriangleController::applyActions(UpperLimbTriangleModel& subject, vector< vector <double> > act)
{
