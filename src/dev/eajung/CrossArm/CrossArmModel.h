...
*/
#ifndef CROSSARM_MODEL_H
#define CROSSARM_MODEL_H
/**
* @file CrossArmModel.h
* @brief Contains the definition of class CrossArmModel.
* $Id$
*/
// This library
...
*/
class CrossArmModel : public tgSubject<CrossArmModel>, public tgModel
{
public:
/**
