...
CrossArmController::CrossArmController(const double initialLength, double timestep) {
this->m_initialLengths=initialLength;
this->m_totalTime=0.0;
this->dt = timestep;
}
//Fetch all the muscles and set their preferred length
void CrossArmController::onSetup(CrossArmModel& subject) {
...
void CrossArmController::onStep(CrossArmModel& subject, double dt) {
...
void CrossArmController::setBrachioradialisTargetLength(CrossArmModel& subject, double dt) {
...
void CrossArmController::setAnconeusTargetLength(CrossArmModel& subject, double dt) {
...
void CrossArmController::moveAllMotors(CrossArmModel& subject, double dt) {
...
void CrossArmController::updateActions(CrossArmModel& subject, double dt) {
...
vector< vector <double> > CrossArmController::transformActions(vector< vector <double> > actions)
{
double min=6;
double max=11;
...
void CrossArmController::applyActions(CrossArmModel& subject, vector< vector <double> > act)
{
