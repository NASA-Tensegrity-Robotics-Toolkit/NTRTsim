...
*/
#ifndef SADDLENECKARM_MODEL_H
#define SADDLENECKARM_MODEL_H
/**
* @file SaddleNeckArmModel.h
* @brief Contains the definition of class SaddleNeckArmModel.
* $Id$
*/
// This library
...
*/
class SaddleNeckArmModel : public tgSubject<SaddleNeckArmModel>, public tgModel
{
public:
/**
