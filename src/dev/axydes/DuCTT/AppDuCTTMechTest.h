...
#ifndef APP_DUCTT_MECH_TEST
#define APP_DUCTT_MECH_TEST
...
//controllers
#include "controllers/DuCTTMechTestController.h"
...
class AppDuCTTMechTest
{
public:
    AppDuCTTMechTest(int argc, char** argv);
