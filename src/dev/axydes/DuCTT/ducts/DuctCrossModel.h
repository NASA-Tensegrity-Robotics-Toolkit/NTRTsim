...
#ifndef DUCT_CROSS_MODEL_H
#define DUCT_CROSS_MODEL_H
 ...
 * in tgcreator.
 */
class DuctCrossModel : public tgModel
{
public: 
    /**
     ...
     */
    DuctCrossModel();
    DuctCrossModel(DuctCrossModel::Config &config);
    
    /**
     * Destructor. Deletes controllers, if any were added during setup.
     * Teardown handles everything else.
     */
    virtual ~DuctCrossModel();
...
private:
    ...
    DuctCrossModel::Config m_config;
};
