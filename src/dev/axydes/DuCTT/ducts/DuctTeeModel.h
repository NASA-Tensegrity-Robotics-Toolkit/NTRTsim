...
#ifndef DUCT_TEE_MODEL_H
#define DUCT_TEE_MODEL_H
 ...
 * in tgcreator.
 */
class DuctTeeModel : public tgModel
{
public: 
    /**
     ...
     */
    DuctTeeModel();
    DuctTeeModel(DuctTeeModel::Config &config);
    
    /**
     * Destructor. Deletes controllers, if any were added during setup.
     * Teardown handles everything else.
     */
    virtual ~DuctTeeModel();
