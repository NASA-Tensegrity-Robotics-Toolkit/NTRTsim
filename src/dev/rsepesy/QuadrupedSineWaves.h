...
#ifndef QUADRUPED_SINE_WAVES_H
#define QUADRUPED_SINE_WAVES_H

/**
 * @file QuadrupedSineWaves.h
 * @brief Contains the definition of class QuadrupedSineWaves
 * @author Brian Tietz
 * @version 1.0.0
 * $Id$
 */
...
/**
 * Control the BaseSpineModelLearning with a series of sine waves
 * and local impedance controllers
 */
class QuadrupedSineWaves : public tgObserver<BaseSpineModelLearning>
{
public:
     ...
     * @param[in] subject - the BaseSpineModelLearning that is being 
