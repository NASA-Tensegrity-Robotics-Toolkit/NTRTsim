...
public:
     ...
     * Does this Box have any nodes in common with the given tgRigidInfo object?
     * @param]in] other a reference to a tgRigidInfo object
     * @retval true if any node in this Box is also in other
     * @retval false if no node in this Box is also in other
     */
