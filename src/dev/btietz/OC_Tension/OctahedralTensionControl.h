...
#ifndef OCTAHEDRAL_TENSION_CONTROL_H
#define OCTAHEDRAL_TENSION_CONTROL_H

/**
 * @file OctahedralTensionControl.h
...
#include "dev/btietz/TC_Tension/JSONGoalTension.h"
...
/**
 * OctahedralTensionControl learns the parameters for a CPG system on a
 ...
 */
class OctahedralTensionControl : public JSONGoalTension
{
public:

    OctahedralTensionControl(JSONGoalControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~OctahedralTensionControl();
