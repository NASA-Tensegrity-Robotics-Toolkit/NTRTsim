...
/**
 * @file CaterpillarRestLengthController.cpp
 * @brief Implementation of a rest length controller for CaterpillarModel.
...
CaterRestLengthController::CaterRestLengthController(const double restLengthDiff) :
...
void CaterRestLengthController::onSetup(CaterpillarModel& subject)
{
...
void CaterRestLengthController::onStep(CaterpillarModel& subject, double dt)
{
    if (dt <= 0.0)
    {
