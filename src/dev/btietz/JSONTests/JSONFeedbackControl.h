...
#ifndef JSON_FEEDBACK_CONTROL_H
#define JSON_FEEDBACK_CONTROL_H
 ...
 */
class JSONFeedbackControl : public JSONCPGControl
{
public:
...
struct Config : public JSONCPGControl::Config
    ...
    JSONFeedbackControl(JSONFeedbackControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONFeedbackControl();
...
protected:
    ...
    JSONFeedbackControl::Config m_config;
