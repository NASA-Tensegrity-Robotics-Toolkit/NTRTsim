...
void TetraSpineStaticModel_hf::setup(tgWorld& world)
{
    ...
    tgLinearString::Config muscleConfig(210.15 * 200.0, 10, false, 0, 7000, 7.0, 1500, 15.0, 14.0);
    tgLinearString::Config muscleConfig2(210.15, 2, false, 0, 7000, 7.0, 1500, 10.0, 10.0);
