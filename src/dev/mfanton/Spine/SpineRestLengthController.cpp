...
/**
 * @file SpineRestLengthController.cpp
 * @brief Implementation of a rest length controller for SpineModel.
...
SpineRestLengthController::SpineRestLengthController()
{
    verticalRL = 7.38 ; // cm
    saddleRL1 = 13.037 ; // cm
    saddleRL2 = 13.613 ; // cm
...
void SpineRestLengthController::onSetup(SpineTestModel& subject)
{
...
void SpineRestLengthController::onStep(SpineTestModel& subject, double dt)
{
    if (dt <= 0.0)
    {
