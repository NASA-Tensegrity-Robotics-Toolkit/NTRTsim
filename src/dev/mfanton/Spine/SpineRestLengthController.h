...
#ifndef Spine_RESTLENGTH_CONTROLLER_H
#define Spine_RESTLENGTH_CONTROLLER_H

/**
 * @file SpineRestLengthController.h
 * @brief Contains the definition of class SpineRestLengthController.
 ...
 */
class SpineRestLengthController : public tgObserver<SpineTestModel>
{
public:
	
  /**
   * Construct a SpineRestLengthController.
  ...
  SpineRestLengthController();
    
  /**
   * Nothing to delete, destructor must be virtual
   */
  virtual ~SpineRestLengthController() { }
   ...
   */
  virtual void onSetup(SpineTestModel& subject);
   ...
   */
  virtual void onStep(SpineTestModel& subject, double dt);
