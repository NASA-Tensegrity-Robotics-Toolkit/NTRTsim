...
#ifndef SPINE_TEST_MODEL_H
#define SPINE_TEST_MODEL_H

/**
 * @file SpineTestModel.h
 * @brief Contains the definition of class SpineTestModel
 * @author Brian Tietz
 * $Id$
 */
