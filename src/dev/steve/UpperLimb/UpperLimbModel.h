...
#ifndef UPPERLIMB_MODEL_H
#define UPPERLIMB_MODEL_H

/**
 * @file UpperLimbModel.h
 * @brief Contains the definition of class UpperLimbModel.
 * $Id$
 */
 ...
 */
class UpperLimbModel : public tgSubject<UpperLimbModel>, public tgModel
{
public: 
