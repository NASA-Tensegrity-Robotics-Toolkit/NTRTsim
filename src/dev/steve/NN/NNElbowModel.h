...
#ifndef NNELBOW_MODEL_H
#define NNELBOW_MODEL_H

/**
 * @file NNElbowModel.h
 * @brief Contains the definition of class NNElbowModel.
 * $Id$
 */
 ...
 */
class NNElbowModel : public tgSubject<NNElbowModel>, public tgModel
{
public: 
...
private:
    ...
    /**
     * Adds markers to the end of the rods so that we can visualize
