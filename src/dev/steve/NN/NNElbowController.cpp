...
/**
 * @file NNElbowController.cpp
 * @brief Preferred Length Controller for NNElbowModel
...
NNElbowController::NNElbowController(const double initialLength, double timestep) :
    m_initialLengths(initialLength),
    m_totalTime(0.0),
    dt(timestep) {}

//Fetch all the muscles and set their preferred length
void NNElbowController::onSetup(NNElbowModel& subject) {
...
void NNElbowController::onStep(NNElbowModel& subject, double dt) {
...
void NNElbowController::setBrachioradialisTargetLength(NNElbowModel& subject, double dt) {
    ...
    for (size_t i=0; i<brachioradialis.size(); i++) {
        ...
        std::cout<<"brachioradialis target length:" << newLength << "\n";
		pMuscle->setControlInput(newLength, dt);
        cout <<"current length at t+1: " << pMuscle->getCurrentLength() << endl;
    }
}

void NNElbowController::setAnconeusTargetLength(NNElbowModel& subject, double dt) {
...
void NNElbowController::moveAllMotors(NNElbowModel& subject, double dt) {
...
void NNElbowController::updateActions(NNElbowModel& subject, double dt) {
...
vector< vector <double> > NNElbowController::transformActions(vector< vector <double> > actions)
{
	double min=6;
	double max=11;
...
void NNElbowController::applyActions(NNElbowModel& subject, vector< vector <double> > act)
{
