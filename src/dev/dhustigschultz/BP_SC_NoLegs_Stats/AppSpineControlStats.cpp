...
#include "AppSpineControlStats.h"
#include "dev/btietz/JSONTests/tgCPGJSONLogger.h"

AppSpineControlStats::AppSpineControlStats(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppSpineControlStats::setup()
{
    ...
    BigPuppySpineOnlyStats* myModel = new BigPuppySpineOnlyStats(segments, hips);
	...
	const double minH = 1.0;
        ...
        JSONStatsFeedbackControl::Config control_config(segmentSpan, 
                                                    numMuscles,
                                                    numMuscles,
                                                    numParams, 
                                                    segNumber, 
...
void AppSpineControlStats::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppSpineControlStats::getHillyConfig()
{
...
const tgBoxGround::Config AppSpineControlStats::getBoxConfig()
{
...
tgModel* AppSpineControlStats::getBlocks()
{
...
tgWorld* AppSpineControlStats::createWorld()
{
...
tgSimViewGraphics *AppSpineControlStats::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppSpineControlStats::createView(tgWorld *world)
{
    return new tgSimView(*world, timestep_physics, timestep_graphics);
}

bool AppSpineControlStats::run()
{
    if (!bSetup)
    {
        setup();
...
void AppSpineControlStats::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppSpineControlStats" << std::endl;
    AppSpineControlStats app (argc, argv);
