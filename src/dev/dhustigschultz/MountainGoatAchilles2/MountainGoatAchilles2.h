...
#ifndef MOUNTAIN_GOAT_ACHILLES2_H
#define MOUNTAIN_GOAT_ACHILLES2_H

/**
 * @file MountainGoatAchilles2.h
...
class MountainGoatAchilles2: public BaseQuadModelLearning 
{
public: 

    MountainGoatAchilles2(int segments, int hips, int legs);

    virtual ~MountainGoatAchilles2();
