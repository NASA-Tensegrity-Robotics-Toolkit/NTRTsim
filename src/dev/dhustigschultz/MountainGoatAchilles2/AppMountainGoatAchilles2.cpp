...
/**
 * @file AppMountainGoatAchilles2.cpp
...
{
    std::cout << "AppMountainGoatAchilles2" << std::endl;
    ...
    MountainGoatAchilles2* const myModel = new MountainGoatAchilles2(segments, hips, legs);
