 ...
 */
 ...
 /**
 * @file MountainGoatAchilles2.cpp
...
//This application
#include "MountainGoatAchilles2.h"
...
MountainGoatAchilles2::MountainGoatAchilles2(int segments, int hips, int legs) :
...
MountainGoatAchilles2::~MountainGoatAchilles2()
{
}

void MountainGoatAchilles2::addNodesLeg(tgStructure& s, double r){ 
...
void MountainGoatAchilles2::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod2");
    s.addPair(1,2,"rod2");
    s.addPair(1,3,"rod2");
    s.addPair(1,4,"rod2");
...
void MountainGoatAchilles2::addNodesHip(tgStructure& s, double r){
...
void MountainGoatAchilles2::addRodsHip(tgStructure& s){
    s.addPair(4,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchilles2::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void MountainGoatAchilles2::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchilles2::addSegments(tgStructure& goat, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, double r){ 
...
void MountainGoatAchilles2::addMuscles(tgStructure& goat){ 
...
void MountainGoatAchilles2::setup(tgWorld& world)
{
...
void MountainGoatAchilles2::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void MountainGoatAchilles2::teardown()
{
