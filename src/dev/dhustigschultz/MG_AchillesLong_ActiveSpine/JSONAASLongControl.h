...
#ifndef JSON_AAS_LONG_CONTROL_H
#define JSON_AAS_LONG_CONTROL_H

/**
 * @file JSONAASLongControl.h
...
/**
 * JSONAASLongControl learns the parameters for a CPG system on a
 ...
 */
class JSONAASLongControl : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSONAASLongControl(JSONAASLongControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONAASLongControl();
...
protected:
    ...
    JSONAASLongControl::Config m_config;
