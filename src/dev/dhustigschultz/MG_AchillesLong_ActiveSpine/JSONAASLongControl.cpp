...
JSONAASLongControl::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSONAASLongControl::JSONAASLongControl(JSONAASLongControl::Config config,	
                                                std::string args,
...
JSONAASLongControl::~JSONAASLongControl()
{
    //delete nn;
}

void JSONAASLongControl::onSetup(BaseQuadModelLearning& subject)
{
...
void JSONAASLongControl::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSONAASLongControl::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
    metrics.clear();
...
void JSONAASLongControl::setupCPGs(BaseQuadModelLearning& subject, array_2D achillesNodeActions, array_4D achillesEdgeActions, array_2D spiralNodeActions, array_4D spiralEdgeActions)
{
...
array_2D JSONAASLongControl::scaleNodeActions (Json::Value actions, double highFreq, double freqFeedbackMax)
{
...
array_4D JSONAASLongControl::scaleEdgeActions  
...
std::vector<double> JSONAASLongControl::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSONAASLongControl::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSONAASLongControl::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
