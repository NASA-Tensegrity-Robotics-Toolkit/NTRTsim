...
#include "AppAASLong.h"
#include "dev/btietz/JSONTests/tgCPGJSONLogger.h"
#include "helpers/FileHelpers.h"
#include <json/json.h>

AppAASLong::AppAASLong(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppAASLong::setup()
{
    ...
    MountainGoatAchillesLongAAS* myModel = new MountainGoatAchillesLongAAS(segments, hips, legs);
	...
	const double ffMax2 = 10.0;
        ...
        JSONAASLongControl::Config control_config(segmentSpan, 
                                                    numMuscles,
                                                    numMuscles,
                                                    numParams, 
                                                    segNumber, 
       ...
       myControl =
        new JSONAASLongControl(control_config, suffix, lowerPath);  
...
void AppAASLong::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppAASLong::getHillyConfig()
{
...
const tgBoxGround::Config AppAASLong::getBoxConfig()
{
...
tgWorld* AppAASLong::createWorld()
{
...
tgSimViewGraphics *AppAASLong::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppAASLong::createView(tgWorld *world)
{
...
void AppAASLong::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppAASLong" << std::endl;
    AppAASLong app (argc, argv);
