...
#ifndef JSON_MG_FEEDBACK_CONTROL_FM0_H
#define JSON_MG_FEEDBACK_CONTROL_FM0_H

/**
 * @file JSONMGFeedbackControlFM0.h
 ...
 */
class JSONMGFeedbackControlFM0 : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSONMGFeedbackControlFM0(JSONMGFeedbackControlFM0::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONMGFeedbackControlFM0();
...
protected:
    ...
    JSONMGFeedbackControlFM0::Config m_config;
