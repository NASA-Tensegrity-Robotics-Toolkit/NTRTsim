...
/**
 * @file JSONHierarchyFeedbackControlSM.cpp
...
#include "JSONHierarchyFeedbackControlSM.h"
...
JSONHierarchyFeedbackControlSM::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSONHierarchyFeedbackControlSM::JSONHierarchyFeedbackControlSM(JSONHierarchyFeedbackControlSM::Config config,	
                                                std::string args,
...
JSONHierarchyFeedbackControlSM::~JSONHierarchyFeedbackControlSM()
{
    delete nn;
}

void JSONHierarchyFeedbackControlSM::onSetup(BaseQuadModelLearning& subject)
{
...
void JSONHierarchyFeedbackControlSM::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSONHierarchyFeedbackControlSM::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
    metrics.clear();
...
void JSONHierarchyFeedbackControlSM::setupCPGs(BaseQuadModelLearning& subject, array_2D spineNodeActions, array_2D legNodeActions, array_4D spineEdgeActions, array_4D hipEdgeActions, array_4D legEdgeActions)
{
...
void JSONHierarchyFeedbackControlSM::setupHighLowCouplings(BaseQuadModelLearning& subject, Json::Value highLowEdgeActions)
{
...
void JSONHierarchyFeedbackControlSM::setupHighCPGs(BaseQuadModelLearning& subject, array_2D highNodeActions, array_4D highEdgeActions)
{
    CPGEquationsFB& m_CPGFBSys = *(tgCast::cast<CPGEquations, CPGEquationsFB>(m_pCPGSys));
...
array_2D JSONHierarchyFeedbackControlSM::scaleNodeActions (Json::Value actions, double highFreq, double freqFeedbackMax)
{
...
array_4D JSONHierarchyFeedbackControlSM::scaleEdgeActions  
...
std::vector<double> JSONHierarchyFeedbackControlSM::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSONHierarchyFeedbackControlSM::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSONHierarchyFeedbackControlSM::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
