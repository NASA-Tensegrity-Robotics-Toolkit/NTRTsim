...
#ifndef APP_QUAD_CONTROL_HIERARCHY_SM_H
#define APP_QUAD_CONTROL_HIERARCHY_SM_H

/**
 * @file AppQuadControlHierarchySM.h
...
//robot
#include "dev/dhustigschultz/MountainGoat_SelectMuscles/MountainGoatSM.h"
...
class AppQuadControlHierarchySM
{
public:
    AppQuadControlHierarchySM(int argc, char** argv);
...
private:
    ...
    JSONHierarchyFeedbackControlSM * myControl;
...
#endif  // APP_QUAD_CONTROL_HIERARCHY_SM_H
