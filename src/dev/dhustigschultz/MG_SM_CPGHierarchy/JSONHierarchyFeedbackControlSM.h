...
#ifndef JSON_HIERARCHY_FEEDBACK_CONTROL_SM_H
#define JSON_HIERARCHY_FEEDBACK_CONTROL_SM_H

/**
 * @file JSONHierarchyFeedbackControlSM.h
 ...
 */
class JSONHierarchyFeedbackControlSM : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSONHierarchyFeedbackControlSM(JSONHierarchyFeedbackControlSM::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONHierarchyFeedbackControlSM();
...
protected:
    ...
    JSONHierarchyFeedbackControlSM::Config m_config;
...
#endif // JSON_HIERARCHY_FEEDBACK_CONTROL_SM_H
