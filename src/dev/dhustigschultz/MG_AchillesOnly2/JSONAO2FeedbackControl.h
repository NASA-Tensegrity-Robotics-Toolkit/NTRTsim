...
#ifndef JSON_AO2_FEEDBACK_CONTROL_H
#define JSON_AO2_FEEDBACK_CONTROL_H

/**
 * @file JSONAO2FeedbackControl.h
...
/**
 * JSONAO2FeedbackControl learns the parameters for a CPG system on a
 ...
 */
class JSONAO2FeedbackControl : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSONAO2FeedbackControl(JSONAO2FeedbackControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONAO2FeedbackControl();
...
protected:
    ...
    JSONAO2FeedbackControl::Config m_config;
