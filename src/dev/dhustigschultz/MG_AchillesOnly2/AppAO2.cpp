...
AppAO2::AppAO2(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppAO2::setup()
{
    ...
    MountainGoatAchilles2* myModel = new MountainGoatAchilles2(segments, hips, legs);
	...
	const double ffMax2 = 10.0;
        ...
        JSONAO2FeedbackControl::Config control_config(segmentSpan, 
                                                    numMuscles,
                                                    numMuscles,
                                                    numParams, 
                                                    segNumber, 
       ...
       myControl =
        new JSONAO2FeedbackControl(control_config, suffix, lowerPath); //JSONAO2FeedbackControl * const 
...
void AppAO2::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppAO2::getHillyConfig()
{
...
const tgBoxGround::Config AppAO2::getBoxConfig()
{
...
tgSimViewGraphics *AppAO2::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppAO2::createView(tgWorld *world)
{
...
void AppAO2::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppAO2" << std::endl;
    AppAO2 app (argc, argv);
