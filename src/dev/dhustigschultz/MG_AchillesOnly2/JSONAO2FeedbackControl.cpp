...
/**
 * @file JSONAO2FeedbackControl.cpp
...
#include "JSONAO2FeedbackControl.h"
...
JSONAO2FeedbackControl::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSONAO2FeedbackControl::JSONAO2FeedbackControl(JSONAO2FeedbackControl::Config config,	
                                                std::string args,
...
JSONAO2FeedbackControl::~JSONAO2FeedbackControl()
{
    //delete nn;
}

void JSONAO2FeedbackControl::onSetup(BaseQuadModelLearning& subject)
{
...
void JSONAO2FeedbackControl::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSONAO2FeedbackControl::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
    metrics.clear();
...
void JSONAO2FeedbackControl::setupCPGs(BaseQuadModelLearning& subject, array_2D achillesNodeActions, array_4D achillesEdgeActions)
{
...
array_2D JSONAO2FeedbackControl::scaleNodeActions (Json::Value actions, double highFreq, double freqFeedbackMax)
{
...
array_4D JSONAO2FeedbackControl::scaleEdgeActions  
...
std::vector<double> JSONAO2FeedbackControl::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSONAO2FeedbackControl::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSONAO2FeedbackControl::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
