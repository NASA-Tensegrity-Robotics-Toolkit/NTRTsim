...
#ifndef MOUNTAIN_GOAT_NL_2_SPIRALS_H
#define MOUNTAIN_GOAT_NL_2_SPIRALS_H

/**
 * @file MountainGoatNL2Spirals.h
...
class MountainGoatNL2Spirals: public BaseQuadModelLearning 
{
public: 

    MountainGoatNL2Spirals(int segments, int hips, int legs);

    virtual ~MountainGoatNL2Spirals();
