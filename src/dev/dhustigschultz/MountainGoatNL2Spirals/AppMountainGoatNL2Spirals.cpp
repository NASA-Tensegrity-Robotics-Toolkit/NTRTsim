...
/**
 * @file AppMountainGoatNL2Spirals.cpp
...
{
    std::cout << "AppMountainGoatNL2Spirals" << std::endl;
    ...
    MountainGoatNL2Spirals* const myModel = new MountainGoatNL2Spirals(segments, hips, legs);
