...
#ifndef JSON_AAS_SHORT_CONTROL_H
#define JSON_AAS_SHORT_CONTROL_H

/**
 * @file JSONAASShortControl.h
...
/**
 * JSONAASShortControl learns the parameters for a CPG system on a
 ...
 */
class JSONAASShortControl : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSONAASShortControl(JSONAASShortControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONAASShortControl();
...
protected:
    ...
    JSONAASShortControl::Config m_config;
...
#endif // JSON_AAS_SHORT_CONTROL_H
