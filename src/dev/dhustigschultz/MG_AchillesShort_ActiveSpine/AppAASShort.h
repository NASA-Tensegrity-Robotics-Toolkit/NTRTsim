...
#ifndef APP_AAS_SHORT_H
#define APP_AAS_SHORT_H
...
//robot
#include "dev/dhustigschultz/MountainGoat_AchillesShortAAS/MountainGoatAchillesShortAAS.h"
...
{
public:
    AppAASShort(int argc, char** argv);
