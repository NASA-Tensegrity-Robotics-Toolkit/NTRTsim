...
#include "AppAASShort.h"
#include "dev/btietz/JSONTests/tgCPGJSONLogger.h"
#include "helpers/FileHelpers.h"
#include <json/json.h>

AppAASShort::AppAASShort(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppAASShort::setup()
{
    ...
    MountainGoatAchillesShortAAS* myModel = new MountainGoatAchillesShortAAS(segments, hips, legs);
	...
	std::string controlFilename = controlFilePath + suffix;
        ...
        const int numMuscles = 2; //This is the achilles muscles! 
	...
	const double ffMax2 = 10.0;
        ...
        JSONAASShortControl::Config control_config(segmentSpan, 
                                                    numMuscles,
                                                    numMuscles,
                                                    numParams, 
                                                    segNumber, 
       ...
       myControl =
        new JSONAASShortControl(control_config, suffix, lowerPath);  
...
void AppAASShort::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppAASShort::getHillyConfig()
{
...
const tgBoxGround::Config AppAASShort::getBoxConfig()
{
...
tgWorld* AppAASShort::createWorld()
{
...
void AppAASShort::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppAASShort" << std::endl;
    AppAASShort app (argc, argv);
