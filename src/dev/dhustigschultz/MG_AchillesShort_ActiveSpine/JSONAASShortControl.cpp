...
JSONAASShortControl::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSONAASShortControl::JSONAASShortControl(JSONAASShortControl::Config config,	
                                                std::string args,
...
JSONAASShortControl::~JSONAASShortControl()
{
    //delete nn;
}

void JSONAASShortControl::onSetup(BaseQuadModelLearning& subject)
{
...
void JSONAASShortControl::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSONAASShortControl::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
    metrics.clear();
...
void JSONAASShortControl::setupCPGs(BaseQuadModelLearning& subject, array_2D achillesNodeActions, array_4D achillesEdgeActions, array_2D spiralNodeActions, array_4D spiralEdgeActions)
{
...
array_2D JSONAASShortControl::scaleNodeActions (Json::Value actions, double highFreq, double freqFeedbackMax)
{
...
array_4D JSONAASShortControl::scaleEdgeActions  
...
std::vector<double> JSONAASShortControl::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSONAASShortControl::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSONAASShortControl::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
