...
#include "AppMGControlFM4.h"
#include "dev/btietz/JSONTests/tgCPGJSONLogger.h"

AppMGControlFM4::AppMGControlFM4(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppMGControlFM4::setup()
{
    ...
    MountainGoatFM4* myModel = new MountainGoatFM4(segments, hips, legs);
	...
	const double minH = 7.0;
        ...
        JSONMGFeedbackControlFM4::Config control_config(segmentSpan, 
                                                    numMuscles,
                                                    numMuscles,
                                                    numParams, 
                                                    segNumber, 
        ...
        myControl =
        new JSONMGFeedbackControlFM4(control_config, suffix, lowerPath);
...
void AppMGControlFM4::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppMGControlFM4::getHillyConfig()
{
...
const tgBoxGround::Config AppMGControlFM4::getBoxConfig()
{
...
tgModel* AppMGControlFM4::getBlocks()
{
...
tgWorld* AppMGControlFM4::createWorld()
{
...
tgSimViewGraphics *AppMGControlFM4::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppMGControlFM4::createView(tgWorld *world)
{
    return new tgSimView(*world, timestep_physics, timestep_graphics);
}

bool AppMGControlFM4::run()
{
    if (!bSetup)
    {
        setup();
...
void AppMGControlFM4::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppMGControlFM4" << std::endl;
    AppMGControlFM4 app (argc, argv);
