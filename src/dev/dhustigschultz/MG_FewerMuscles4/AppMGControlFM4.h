...
#ifndef APP_MG_CONTROL_FM4_H
#define APP_MG_CONTROL_FM4_H
...
//robot
#include "dev/dhustigschultz/MountainGoatFM4/MountainGoatFM4.h"
...
class AppMGControlFM4
{
public:
   AppMGControlFM4(int argc, char** argv);
...
private:
    ...
    JSONMGFeedbackControlFM4 * myControl;
