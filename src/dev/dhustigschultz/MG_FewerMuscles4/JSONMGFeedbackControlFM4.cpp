...
/**
 * @file JSONMGFeedbackControlFM4.cpp
...
#include "JSONMGFeedbackControlFM4.h"
...
JSONMGFeedbackControlFM4::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSONMGFeedbackControlFM4::JSONMGFeedbackControlFM4(JSONMGFeedbackControlFM4::Config config,	
                                                std::string args,
...
JSONMGFeedbackControlFM4::~JSONMGFeedbackControlFM4()
{
    delete nn;
}

void JSONMGFeedbackControlFM4::onSetup(BaseQuadModelLearning& subject)
{
...
void JSONMGFeedbackControlFM4::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSONMGFeedbackControlFM4::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
...
void JSONMGFeedbackControlFM4::setupCPGs(BaseQuadModelLearning& subject, array_2D nodeActions, array_4D edgeActions)
{
...
array_2D JSONMGFeedbackControlFM4::scaleNodeActions (Json::Value actions)
{
...
std::vector<double> JSONMGFeedbackControlFM4::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSONMGFeedbackControlFM4::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSONMGFeedbackControlFM4::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
