...
#ifdef SMALL_HILLS
    puppy.move(btVector3(0.0,-yOffset_foot+5,0.0));
#endif

#ifdef LARGE_HILLS
    puppy.move(btVector3(0.0,-yOffset_foot+12,0.0)); 
#endif
...
#ifdef BLOCKY_GROUND
    puppy.move(btVector3(0.0,55.0,0.0));
#endif

#ifdef STAIRS
    puppy.move(btVector3(0.0,0.0,0.0));
#endif
