...
AppMGControlFM1::AppMGControlFM1(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
void AppMGControlFM1::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppMGControlFM1::getHillyConfig()
{
...
const tgBoxGround::Config AppMGControlFM1::getBoxConfig()
{
...
tgModel* AppMGControlFM1::getBlocks()
{
...
tgWorld* AppMGControlFM1::createWorld()
{
...
tgSimViewGraphics *AppMGControlFM1::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppMGControlFM1::createView(tgWorld *world)
{
    return new tgSimView(*world, timestep_physics, timestep_graphics);
}

bool AppMGControlFM1::run()
{
    if (!bSetup)
    {
        setup();
...
void AppMGControlFM1::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppMGControlFM1" << std::endl;
    AppMGControlFM1 app (argc, argv);
