...
#ifndef JSON_MG_FEEDBACK_CONTROL_FM1_H
#define JSON_MG_FEEDBACK_CONTROL_FM1_H

/**
 * @file JSONMGFeedbackControlFM1.h
 ...
 */
class JSONMGFeedbackControlFM1 : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSONMGFeedbackControlFM1(JSONMGFeedbackControlFM1::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONMGFeedbackControlFM1();
...
protected:
    ...
    JSONMGFeedbackControlFM1::Config m_config;
