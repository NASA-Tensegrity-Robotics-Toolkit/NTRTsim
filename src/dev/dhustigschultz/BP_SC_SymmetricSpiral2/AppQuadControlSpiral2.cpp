...
AppQuadControlSpiral2::AppQuadControlSpiral2(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppQuadControlSpiral2::setup()
{
...
void AppQuadControlSpiral2::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppQuadControlSpiral2::getHillyConfig()
{
...
const tgBoxGround::Config AppQuadControlSpiral2::getBoxConfig()
{
...
tgModel* AppQuadControlSpiral2::getBlocks()
{
...
tgWorld* AppQuadControlSpiral2::createWorld()
{
...
tgSimViewGraphics *AppQuadControlSpiral2::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppQuadControlSpiral2::createView(tgWorld *world)
{
    return new tgSimView(*world, timestep_physics, timestep_graphics);
}

bool AppQuadControlSpiral2::run()
{
    if (!bSetup)
    {
        setup();
...
void AppQuadControlSpiral2::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppQuadControlSpiral2" << std::endl;
    AppQuadControlSpiral2 app (argc, argv);
