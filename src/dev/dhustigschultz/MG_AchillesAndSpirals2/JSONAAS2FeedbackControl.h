...
#ifndef JSON_AAS2_FEEDBACK_CONTROL_H
#define JSON_AAS2_FEEDBACK_CONTROL_H

/**
 * @file JSONAAS2FeedbackControl.h
...
/**
 * JSONAAS2FeedbackControl learns the parameters for a CPG system on a
 ...
 */
class JSONAAS2FeedbackControl : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSONAAS2FeedbackControl(JSONAAS2FeedbackControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONAAS2FeedbackControl();
...
protected:
    ...
    JSONAAS2FeedbackControl::Config m_config;
...
#endif // JSON_AAS2_FEEDBACK_CONTROL_H
