...
/**
 * @file JSONAAS2FeedbackControl.cpp
...
#include "JSONAAS2FeedbackControl.h"
...
JSONAAS2FeedbackControl::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSONAAS2FeedbackControl::JSONAAS2FeedbackControl(JSONAAS2FeedbackControl::Config config,	
                                                std::string args,
...
JSONAAS2FeedbackControl::~JSONAAS2FeedbackControl()
{
    //delete nn;
}

void JSONAAS2FeedbackControl::onSetup(BaseQuadModelLearning& subject)
{
...
void JSONAAS2FeedbackControl::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSONAAS2FeedbackControl::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
    metrics.clear();
...
void JSONAAS2FeedbackControl::setupCPGs(BaseQuadModelLearning& subject, array_2D achillesNodeActions, array_4D achillesEdgeActions, array_2D spiralNodeActions, array_4D spiralEdgeActions)
{
...
array_2D JSONAAS2FeedbackControl::scaleNodeActions (Json::Value actions, double highFreq, double freqFeedbackMax)
{
...
array_4D JSONAAS2FeedbackControl::scaleEdgeActions  
...
std::vector<double> JSONAAS2FeedbackControl::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSONAAS2FeedbackControl::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSONAAS2FeedbackControl::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
