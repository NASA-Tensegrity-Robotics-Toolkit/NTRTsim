...
AppAAS2::AppAAS2(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppAAS2::setup()
{
    ...
    MountainGoatAchillesSpirals2* myModel = new MountainGoatAchillesSpirals2(segments, hips, legs);
	...
	const double ffMax2 = 10.0;
        ...
        JSONAAS2FeedbackControl::Config control_config(segmentSpan, 
                                                    numMuscles,
                                                    numMuscles,
                                                    numParams, 
                                                    segNumber, 
       ...
       myControl =
        new JSONAAS2FeedbackControl(control_config, suffix, lowerPath);  
...
void AppAAS2::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppAAS2::getHillyConfig()
{
...
const tgBoxGround::Config AppAAS2::getBoxConfig()
{
...
tgSimViewGraphics *AppAAS2::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppAAS2::createView(tgWorld *world)
{
...
void AppAAS2::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppAAS2" << std::endl;
    AppAAS2 app (argc, argv);
