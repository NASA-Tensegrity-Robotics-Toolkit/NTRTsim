...
#ifndef MOUNTAIN_GOAT_FM4_H
#define MOUNTAIN_GOAT_FM4_H

/**
 * @file MountainGoatFM4.h
 * @brief Trying MountainGoat, with the last 4 spiral muscles passive.
...
class MountainGoatFM4: public BaseQuadModelLearning 
{
public: 

    MountainGoatFM4(int segments, int hips, int legs);

    virtual ~MountainGoatFM4();
