 ...
 */
 ...
 /**
 * @file MountainGoatFM4.cpp
 * @brief Implementing Mountain Goat with the last 4 spiral muscles passive.
...
MountainGoatFM4::MountainGoatFM4(int segments, int hips, int legs) :
...
MountainGoatFM4::~MountainGoatFM4()
{
}

void MountainGoatFM4::addNodesLeg(tgStructure& s, double r){ 
...
void MountainGoatFM4::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(1,2,"rod");
    s.addPair(1,3,"rod");
    s.addPair(1,4,"rod");
...
void MountainGoatFM4::addNodesHip(tgStructure& s, double r){
...
void MountainGoatFM4::addRodsHip(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
}

void MountainGoatFM4::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void MountainGoatFM4::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatFM4::addSegments(tgStructure& goat, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, double r){ 
...
void MountainGoatFM4::addMuscles(tgStructure& goat){ 
	...
	if (i >= 3 && i < 7){
        ...
        else if( i==2 ){ //Unrolling the first iteration of the above loop, to remove the "spiral" label
	    goat.addPair(n1[3], n2[3], tgString("spine all muscleAct1 seg", i-1) + tgString(" seg", i));
	    goat.addPair(n1[4], n2[3], tgString("spine all muscleAct1 seg", i-1) + tgString(" seg", i));
	    goat.addPair(n1[3], n2[4], tgString("spine all muscleAct1 seg", i-1) + tgString(" seg", i));
	    goat.addPair(n1[4], n2[4], tgString("spine all muscleAct1 seg", i-1) + tgString(" seg", i));
	}
        if(i == 6){
            //rear
...
void MountainGoatFM4::setup(tgWorld& world)
{
...
void MountainGoatFM4::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
