...
/**
 * @file tgCPGGeneralActuatorControl.cpp
...
tgCPGGeneralActuatorControl::tgCPGGeneralActuatorControl(const double controlStep) :
m_controlTime(0.0),
m_totalTime(0.0),
...
tgCPGGeneralActuatorControl::~tgCPGGeneralActuatorControl()
{
	// We don't own these
	m_pFromBody = NULL;
	m_pToBody = NULL;
...
void tgCPGGeneralActuatorControl::onAttach(tgSpringCableActuator& subject)
{
...
void tgCPGGeneralActuatorControl::onStep(tgSpringCableActuator& subject, double dt)
{
    m_controlTime += dt;
	m_totalTime += dt;
...
void tgCPGGeneralActuatorControl::assignNodeNumber (CPGEquations& CPGSys, array_2D nodeParams)
{
...
void
tgCPGGeneralActuatorControl::setConnectivity(const std::vector<tgCPGGeneralActuatorControl*>& allStrings,
                       array_4D edgeParams) 
{
...
void tgCPGGeneralActuatorControl::setupControl(tgImpedanceController& ipc)
{
