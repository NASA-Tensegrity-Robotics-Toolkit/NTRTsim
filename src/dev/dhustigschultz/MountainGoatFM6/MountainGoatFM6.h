...
#ifndef MOUNTAIN_GOAT_FM6_H
#define MOUNTAIN_GOAT_FM6_H
...
class MountainGoatFM6: public BaseQuadModelLearning 
{
public: 

    MountainGoatFM6(int segments, int hips, int legs);

    virtual ~MountainGoatFM6();
