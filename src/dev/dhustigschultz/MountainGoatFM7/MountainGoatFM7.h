...
#ifndef MOUNTAIN_GOAT_FM7_H
#define MOUNTAIN_GOAT_FM7_H

/**
 * @file MountainGoatFM7.h
 * @brief Implementing MountainGoat, with the short hip-to-spine connector muscles removed.
...
class MountainGoatFM7: public BaseQuadModelLearning 
{
public: 

    MountainGoatFM7(int segments, int hips, int legs);

    virtual ~MountainGoatFM7();
