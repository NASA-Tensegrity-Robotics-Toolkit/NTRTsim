...
/**
 * @file MountainGoatFM7.h
 * @brief Implementing MountainGoat, with the long hip-to-spine connector muscles as well as the lateral leg-to-spine muscles removed.
 * Trying to determine if these muscles are getting in the way of others. 
...
MountainGoatFM7::MountainGoatFM7(int segments, int hips, int legs) :
...
MountainGoatFM7::~MountainGoatFM7()
{
}

void MountainGoatFM7::addNodesLeg(tgStructure& s, double r){ 
...
void MountainGoatFM7::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(1,2,"rod");
    s.addPair(1,3,"rod");
    s.addPair(1,4,"rod");
...
void MountainGoatFM7::addNodesHip(tgStructure& s, double r){
...
void MountainGoatFM7::addRodsHip(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
}

void MountainGoatFM7::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void MountainGoatFM7::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatFM7::addSegments(tgStructure& goat, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, double r){ 
...
void MountainGoatFM7::addMuscles(tgStructure& goat){ 
...
void MountainGoatFM7::setup(tgWorld& world)
{
...
void MountainGoatFM7::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
