 ...
 */
 ...
 /**
 * @file MountainGoatAchillesLong.cpp
...
//This application
#include "MountainGoatAchillesLong.h"
...
MountainGoatAchillesLong::MountainGoatAchillesLong(int segments, int hips, int legs) :
...
MountainGoatAchillesLong::~MountainGoatAchillesLong()
{
}

void MountainGoatAchillesLong::addNodesLeg(tgStructure& s, double r){ 
...
void MountainGoatAchillesLong::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod2");
    s.addPair(1,2,"rod2");
    s.addPair(1,3,"rod2");
    s.addPair(1,4,"rod2");
...
void MountainGoatAchillesLong::addNodesHip(tgStructure& s, double r){
...
void MountainGoatAchillesLong::addRodsHip(tgStructure& s){
    s.addPair(4,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchillesLong::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void MountainGoatAchillesLong::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchillesLong::addSegments(tgStructure& goat, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, double r){ 
...
void MountainGoatAchillesLong::addMuscles(tgStructure& goat){ 
...
void MountainGoatAchillesLong::setup(tgWorld& world)
{
...
void MountainGoatAchillesLong::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void MountainGoatAchillesLong::teardown()
{
