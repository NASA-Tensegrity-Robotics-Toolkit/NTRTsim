...
#ifndef MOUNTAIN_GOAT_ACHILLES_LONG_H
#define MOUNTAIN_GOAT_ACHILLES_LONG_H

/**
 * @file MountainGoatAchillesLong.h
 * @brief Trying a longer achilles tendon muscle on the MountainGoat.
 * Trying longer lower legs and achilles muscles, to see if speed increases.
...
class MountainGoatAchillesLong: public BaseQuadModelLearning 
{
public: 

    MountainGoatAchillesLong(int segments, int hips, int legs);

    virtual ~MountainGoatAchillesLong();
