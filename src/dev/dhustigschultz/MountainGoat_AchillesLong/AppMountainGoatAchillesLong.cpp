...
/**
 * @file AppMountainGoatAchillesLong.cpp
...
{
    std::cout << "AppMountainGoatAchillesLong" << std::endl;
    ...
    MountainGoatAchillesLong* const myModel = new MountainGoatAchillesLong(segments, hips, legs);
