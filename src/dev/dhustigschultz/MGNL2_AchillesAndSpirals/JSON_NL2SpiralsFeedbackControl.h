...
#ifndef JSON_NL2SPIRALS_FEEDBACK_CONTROL_H
#define JSON_NL2SPIRALS_FEEDBACK_CONTROL_H

/**
 * @file JSON_NL2SpiralsFeedbackControl.h
...
/**
 * JSON_NL2SpiralsFeedbackControl learns the parameters for a CPG system on a
 ...
 */
class JSON_NL2SpiralsFeedbackControl : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
	...
	int ourSpiralMuscles;
	int theirSpiralMuscles;
  	/*int ourLegMuscles;
 	int theirLegMuscles;
    ...
    JSON_NL2SpiralsFeedbackControl(JSON_NL2SpiralsFeedbackControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSON_NL2SpiralsFeedbackControl();
...
protected:
    ...
    virtual void setupCPGs(BaseQuadModelLearning& subject, array_2D achillesNodeActions, array_4D achillesEdgeActions, array_2D spiralNodeActions, array_4D spiralEdgeActions); 
    ...
    JSON_NL2SpiralsFeedbackControl::Config m_config;
    ...
    std::vector<tgCPGActuatorControl*> m_spiralControllers;
...
#endif // JSON_NL2SPIRALS_FEEDBACK_CONTROL_H
