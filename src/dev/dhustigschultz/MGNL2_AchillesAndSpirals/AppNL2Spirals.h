...
#ifndef APP_NL2_SPIRALS_H
#define APP_NL2_SPIRALS_H

/**
 * @file AppNL2Spirals.h
...
//robot
#include "dev/dhustigschultz/MountainGoatNL2Spirals/MountainGoatNL2Spirals.h"
...
{
public:
    AppNL2Spirals(int argc, char** argv);
...
private:
    ...
    JSON_NL2SpiralsFeedbackControl * myControl;
