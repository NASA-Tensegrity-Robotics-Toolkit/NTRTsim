...
#include "AppNL2Spirals.h"
#include "dev/btietz/JSONTests/tgCPGJSONLogger.h"
#include "helpers/FileHelpers.h"
#include <json/json.h>

AppNL2Spirals::AppNL2Spirals(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppNL2Spirals::setup()
{
    ...
    MountainGoatNL2Spirals* myModel = new MountainGoatNL2Spirals(segments, hips, legs);
	...
	std::string controlFilename = controlFilePath + suffix;
        ...
        const int numMuscles = 7; //This is the achilles muscles! 
	...
	const double numLegMuscles = 6;  
        const double numSpiralMuscles = 8;
	...
	const double ffMax2 = 10.0;
        ...
        JSON_NL2SpiralsFeedbackControl::Config control_config(segmentSpan, 
                                                    numMuscles,
                                                    numMuscles,
                                                    numParams, 
                                                    segNumber, 
       ...
       myControl =
        new JSON_NL2SpiralsFeedbackControl(control_config, suffix, lowerPath);  
...
void AppNL2Spirals::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppNL2Spirals::getHillyConfig()
{
...
const tgBoxGround::Config AppNL2Spirals::getBoxConfig()
{
...
tgModel* AppNL2Spirals::getBlocks()
{
...
tgWorld* AppNL2Spirals::createWorld()
{
...
tgSimViewGraphics *AppNL2Spirals::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppNL2Spirals::createView(tgWorld *world)
{
    return new tgSimView(*world, timestep_physics, timestep_graphics);
}

bool AppNL2Spirals::run()
{
    if (!bSetup)
    {
        setup();
...
void AppNL2Spirals::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppNL2Spirals" << std::endl;
    AppNL2Spirals app (argc, argv);
