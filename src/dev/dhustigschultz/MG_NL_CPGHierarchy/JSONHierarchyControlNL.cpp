...
/**
 * @file JSONHierarchyControlNL.cpp
...
#include "JSONHierarchyControlNL.h"
...
JSONHierarchyControlNL::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSONHierarchyControlNL::JSONHierarchyControlNL(JSONHierarchyControlNL::Config config,	
                                                std::string args,
...
JSONHierarchyControlNL::~JSONHierarchyControlNL()
{
    delete nn;
}

void JSONHierarchyControlNL::onSetup(BaseQuadModelLearning& subject)
{
...
void JSONHierarchyControlNL::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSONHierarchyControlNL::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
    metrics.clear();
...
void JSONHierarchyControlNL::setupCPGs(BaseQuadModelLearning& subject, array_2D spineNodeActions, array_2D legNodeActions, array_4D spineEdgeActions, array_4D hipEdgeActions, array_4D legEdgeActions)
{
...
void JSONHierarchyControlNL::setupHighLowCouplings(BaseQuadModelLearning& subject, Json::Value highLowEdgeActions)
{
...
void JSONHierarchyControlNL::setupHighCPGs(BaseQuadModelLearning& subject, array_2D highNodeActions, array_4D highEdgeActions)
{
    CPGEquationsFB& m_CPGFBSys = *(tgCast::cast<CPGEquations, CPGEquationsFB>(m_pCPGSys));
...
array_2D JSONHierarchyControlNL::scaleNodeActions (Json::Value actions, double highFreq, double freqFeedbackMax)
{
...
array_4D JSONHierarchyControlNL::scaleEdgeActions  
...
std::vector<double> JSONHierarchyControlNL::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSONHierarchyControlNL::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSONHierarchyControlNL::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
