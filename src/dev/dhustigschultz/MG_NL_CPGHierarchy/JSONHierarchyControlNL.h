...
#ifndef JSON_HIERARCHY_CONTROL_NL_H
#define JSON_HIERARCHY_CONTROL_NL_H

/**
 * @file JSONHierarchyControlNL.h
 ...
 */
class JSONHierarchyControlNL : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSONHierarchyControlNL(JSONHierarchyControlNL::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONHierarchyControlNL();
...
protected:
    ...
    JSONHierarchyControlNL::Config m_config;
...
#endif // JSON_HIERARCHY_CONTROL_NL_H
