...
#ifndef APP_MG_HIERARCHY_NL_H
#define APP_MG_HIERARCHY_NL_H

/**
 * @file AppMGHierarchyNL.h
...
//robot
#include "dev/dhustigschultz/MountainGoatNL/MountainGoatNL.h"
...
class AppMGHierarchyNL
{
public:
    AppMGHierarchyNL(int argc, char** argv);
...
private:
    ...
    JSONHierarchyControlNL * myControl;
