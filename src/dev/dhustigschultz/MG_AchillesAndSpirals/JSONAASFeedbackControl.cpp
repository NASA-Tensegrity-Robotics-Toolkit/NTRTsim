...
/**
 * @file JSONAASFeedbackControl.cpp
...
#include "JSONAASFeedbackControl.h"
...
JSONAASFeedbackControl::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSONAASFeedbackControl::JSONAASFeedbackControl(JSONAASFeedbackControl::Config config,	
                                                std::string args,
...
JSONAASFeedbackControl::~JSONAASFeedbackControl()
{
    //delete nn;
}

void JSONAASFeedbackControl::onSetup(BaseQuadModelLearning& subject)
{
...
void JSONAASFeedbackControl::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSONAASFeedbackControl::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
    metrics.clear();
...
void JSONAASFeedbackControl::setupCPGs(BaseQuadModelLearning& subject, array_2D achillesNodeActions, array_4D achillesEdgeActions, array_2D spiralNodeActions, array_4D spiralEdgeActions)
{
...
array_2D JSONAASFeedbackControl::scaleNodeActions (Json::Value actions, double highFreq, double freqFeedbackMax)
{
...
array_4D JSONAASFeedbackControl::scaleEdgeActions  
...
std::vector<double> JSONAASFeedbackControl::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSONAASFeedbackControl::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSONAASFeedbackControl::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
