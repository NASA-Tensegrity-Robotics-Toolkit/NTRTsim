...
#ifndef JSON_AAS_FEEDBACK_CONTROL_H
#define JSON_AAS_FEEDBACK_CONTROL_H

/**
 * @file JSONAASFeedbackControl.h
...
/**
 * JSONAASFeedbackControl learns the parameters for a CPG system on a
 ...
 */
class JSONAASFeedbackControl : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSONAASFeedbackControl(JSONAASFeedbackControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONAASFeedbackControl();
...
protected:
    ...
    JSONAASFeedbackControl::Config m_config;
...
#endif // JSON_AAS_FEEDBACK_CONTROL_H
