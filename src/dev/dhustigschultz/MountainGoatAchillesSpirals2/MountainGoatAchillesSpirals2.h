...
#ifndef MOUNTAIN_GOAT_ACHILLES_SPIRALS_2_H
#define MOUNTAIN_GOAT_ACHILLES_SPIRALS_2_H

/**
 * @file MountainGoatAchillesSpirals2.h
...
class MountainGoatAchillesSpirals2: public BaseQuadModelLearning 
{
public: 

    MountainGoatAchillesSpirals2(int segments, int hips, int legs);

    virtual ~MountainGoatAchillesSpirals2();
