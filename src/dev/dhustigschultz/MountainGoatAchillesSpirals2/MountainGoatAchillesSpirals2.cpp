 ...
 */
 ...
 /**
 * @file MountainGoatAchillesSpirals2.cpp
...
//This application
#include "MountainGoatAchillesSpirals2.h"
...
MountainGoatAchillesSpirals2::MountainGoatAchillesSpirals2(int segments, int hips, int legs) :
...
MountainGoatAchillesSpirals2::~MountainGoatAchillesSpirals2()
{
}

void MountainGoatAchillesSpirals2::addNodesLeg(tgStructure& s, double r){ 
    s.addNode(0,0,0); //0: Bottom Center of lower leg segment
    s.addNode(0,r,0);  //1: Center of lower leg segment
    s.addNode(r/2,r,0); //2: Right of lower leg segment
    s.addNode(-r/2,r,0);  //3: Left of lower leg segment
...
void MountainGoatAchillesSpirals2::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod2");
    s.addPair(1,2,"rod2");
    s.addPair(1,3,"rod2");
    s.addPair(1,4,"rod2");
...
void MountainGoatAchillesSpirals2::addNodesHip(tgStructure& s, double r){
...
void MountainGoatAchillesSpirals2::addRodsHip(tgStructure& s){
    s.addPair(4,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchillesSpirals2::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void MountainGoatAchillesSpirals2::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchillesSpirals2::addSegments(tgStructure& goat, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, double r){ 
...
void MountainGoatAchillesSpirals2::addMuscles(tgStructure& goat){ 
...
void MountainGoatAchillesSpirals2::setup(tgWorld& world)
{
...
void MountainGoatAchillesSpirals2::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void MountainGoatAchillesSpirals2::teardown()
{
