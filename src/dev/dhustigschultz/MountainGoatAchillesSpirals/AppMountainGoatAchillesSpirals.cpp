...
/**
 * @file AppMountainGoatAchillesSpirals.cpp
...
{
    std::cout << "AppMountainGoatAchillesSpirals" << std::endl;
    ...
    MountainGoatAchillesSpirals* const myModel = new MountainGoatAchillesSpirals(segments, hips, legs);
