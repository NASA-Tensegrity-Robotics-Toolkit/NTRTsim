...
#ifndef MOUNTAIN_GOAT_ACHILLES_SPIRALS_H
#define MOUNTAIN_GOAT_ACHILLES_SPIRALS_H

/**
 * @file MountainGoatAchillesSpirals.h
...
class MountainGoatAchillesSpirals: public BaseQuadModelLearning 
{
public: 

    MountainGoatAchillesSpirals(int segments, int hips, int legs);

    virtual ~MountainGoatAchillesSpirals();
