 ...
 */
 ...
 /**
 * @file MountainGoatAchillesSpirals.cpp
...
//This application
#include "MountainGoatAchillesSpirals.h"
...
MountainGoatAchillesSpirals::MountainGoatAchillesSpirals(int segments, int hips, int legs) :
...
MountainGoatAchillesSpirals::~MountainGoatAchillesSpirals()
{
}

void MountainGoatAchillesSpirals::addNodesLeg(tgStructure& s, double r){ 
...
void MountainGoatAchillesSpirals::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod2");
    s.addPair(1,2,"rod2");
    s.addPair(1,3,"rod2");
    s.addPair(1,4,"rod2");
...
void MountainGoatAchillesSpirals::addNodesHip(tgStructure& s, double r){
...
void MountainGoatAchillesSpirals::addRodsHip(tgStructure& s){
    s.addPair(4,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchillesSpirals::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void MountainGoatAchillesSpirals::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchillesSpirals::addSegments(tgStructure& goat, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, double r){ 
...
void MountainGoatAchillesSpirals::addMuscles(tgStructure& goat){ 
...
void MountainGoatAchillesSpirals::setup(tgWorld& world)
{
...
void MountainGoatAchillesSpirals::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void MountainGoatAchillesSpirals::teardown()
{
