...
JSONMGSingleLegControl::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSONMGSingleLegControl::JSONMGSingleLegControl(JSONMGSingleLegControl::Config config,	
                                                std::string args,
...
JSONMGSingleLegControl::~JSONMGSingleLegControl()
{
    delete nn;
}

void JSONMGSingleLegControl::onSetup(BaseQuadModelLearning& subject)
{
...
void JSONMGSingleLegControl::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSONMGSingleLegControl::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
    metrics.clear();
...
void JSONMGSingleLegControl::setupCPGs(BaseQuadModelLearning& subject, array_2D nodeActions, array_4D edgeActions)
{
...
array_2D JSONMGSingleLegControl::scaleNodeActions (Json::Value actions)
{
...
std::vector<double> JSONMGSingleLegControl::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSONMGSingleLegControl::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSONMGSingleLegControl::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
...
void JSONMGSingleLegControl::printMetrics(BaseQuadModelLearning& subject){
