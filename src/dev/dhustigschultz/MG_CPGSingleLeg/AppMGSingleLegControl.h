...
#ifndef APP_MG_SINGLE_LEG_CONTROL_H
#define APP_MG_SINGLE_LEG_CONTROL_H

/**
 * @file AppMGSingleLegControl.h
...
class AppMGSingleLegControl
{
public:
    AppMGSingleLegControl(int argc, char** argv);
...
#endif  // APP_MG_SINGLE_LEG_CONTROL_H
