...
/**
 * @file AppMGSingleLegControl.cpp
...
#include "AppMGSingleLegControl.h"
#include "dev/btietz/JSONTests/tgCPGJSONLogger.h"

AppMGSingleLegControl::AppMGSingleLegControl(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppMGSingleLegControl::setup()
{
    ...
    MGSingleLeg* myModel = new MGSingleLeg(segments, hips, legs);
	...
	const double minH = 1.0;
        ...
        JSONMGSingleLegControl::Config control_config(segmentSpan, 
                                                    numMuscles,
                                                    numMuscles,
                                                    numParams, 
                                                    segNumber, 
       ...
       JSONMGSingleLegControl* const myControl =
        new JSONMGSingleLegControl(control_config, suffix, lowerPath);
...
void AppMGSingleLegControl::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppMGSingleLegControl::getHillyConfig()
{
...
const tgBoxGround::Config AppMGSingleLegControl::getBoxConfig()
{
...
tgModel* AppMGSingleLegControl::getBlocks()
{
...
tgWorld* AppMGSingleLegControl::createWorld()
{
...
tgSimViewGraphics *AppMGSingleLegControl::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppMGSingleLegControl::createView(tgWorld *world)
{
    return new tgSimView(*world, timestep_physics, timestep_graphics);
}

bool AppMGSingleLegControl::run()
{
    if (!bSetup)
    {
        setup();
...
void AppMGSingleLegControl::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppMGSingleLegControl" << std::endl;
    AppMGSingleLegControl app (argc, argv);
