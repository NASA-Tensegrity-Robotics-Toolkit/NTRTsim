...
#ifndef JSON_MG_SINGLE_LEG_CONTROL_H
#define JSON_MG_SINGLE_LEG_CONTROL_H

/**
 * @file JSONMGSingleLegControl.h
...
/**
 * JSONMGSingleLegControl learns the parameters for a CPG system on a
 * leg tensegrity structure specified as a BaseSpineModelLearning. Parameters are generated by
 ...
 */
class JSONMGSingleLegControl : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSONMGSingleLegControl(JSONMGSingleLegControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONMGSingleLegControl();
...
protected:
    ...
    JSONMGSingleLegControl::Config m_config;
