...
#ifndef MOUNTAIN_GOAT_FM5_H
#define MOUNTAIN_GOAT_FM5_H
...
class MountainGoatFM5: public BaseQuadModelLearning 
{
public: 

    MountainGoatFM5(int segments, int hips, int legs);

    virtual ~MountainGoatFM5();
