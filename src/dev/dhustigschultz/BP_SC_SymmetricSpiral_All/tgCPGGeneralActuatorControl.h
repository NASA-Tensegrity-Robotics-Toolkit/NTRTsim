...
#ifndef TG_CPG_GENERAL_CONTRL_H
#define TG_CPG_GENERAL_CONTRL_H
...
class tgCPGGeneralActuatorControl : public tgObserver<tgSpringCableActuator>,
							public tgBaseCPGNode
{
public:
 
    tgCPGGeneralActuatorControl(const double controlStep = 1.0/10000.0);
    
    virtual ~tgCPGGeneralActuatorControl();
     ...
     */
    void setConnectivity(const std::vector<tgCPGGeneralActuatorControl*>& allStrings,
             array_4D edgeParams);
