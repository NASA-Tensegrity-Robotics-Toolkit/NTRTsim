...
tgCPGGeneralCableControl::tgCPGGeneralCableControl(tgPIDController::Config pid_config, const double controlStep) :
m_config(pid_config),
tgCPGGeneralActuatorControl(controlStep),
m_PID(NULL),
usePID(true)
{
...
tgCPGGeneralCableControl::~tgCPGGeneralCableControl()
{
    delete m_PID;
}

void tgCPGGeneralCableControl::onSetup(tgSpringCableActuator& subject)
{
...
void tgCPGGeneralCableControl::onStep(tgSpringCableActuator& subject, double dt)
{
...
void tgCPGGeneralCableControl::assignNodeNumberFB (CPGEquationsFB& CPGSys, array_2D nodeParams)
{
