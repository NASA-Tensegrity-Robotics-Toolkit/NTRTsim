...
/**
 * @file JSONGeneralFeedbackControl.cpp
...
JSONGeneralFeedbackControl::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSONGeneralFeedbackControl::JSONGeneralFeedbackControl(JSONGeneralFeedbackControl::Config config,	
                                                std::string args,
...
JSONGeneralFeedbackControl::~JSONGeneralFeedbackControl()
{
    delete nn;
}

void JSONGeneralFeedbackControl::onSetup(BaseQuadModelLearning& subject)
{
    m_pCPGSys = new CPGEquationsFB(100000);
...
void JSONGeneralFeedbackControl::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSONGeneralFeedbackControl::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
    metrics.clear();
...
void JSONGeneralFeedbackControl::setupCPGs(BaseQuadModelLearning& subject, array_2D nodeActions, array_4D edgeActions)
{
...
array_2D JSONGeneralFeedbackControl::scaleNodeActions (Json::Value actions)
{
...
array_4D JSONGeneralFeedbackControl::scaleEdgeActions  
...
std::vector<double> JSONGeneralFeedbackControl::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSONGeneralFeedbackControl::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSONGeneralFeedbackControl::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
