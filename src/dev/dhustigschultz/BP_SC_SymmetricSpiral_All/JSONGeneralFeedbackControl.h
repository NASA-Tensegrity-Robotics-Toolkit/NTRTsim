...
#ifndef JSON_GENERAL_FEEDBACK_CONTROL_H
#define JSON_GENERAL_FEEDBACK_CONTROL_H
 ...
 */
class JSONGeneralFeedbackControl : public JSONQuadCPGGeneralControl
{
public:
...
struct Config : public JSONQuadCPGGeneralControl::Config
    ...
    JSONGeneralFeedbackControl(JSONGeneralFeedbackControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONGeneralFeedbackControl();
...
//ToDo: May have to write a new function in this subclass, to handle the fact that we'll be skipping segments now. Not sure if scale edge actions will work in all cases.... and maybe there's something better?
    ...
    JSONGeneralFeedbackControl::Config m_config;
...
#endif // JSON_GENERAL_FEEDBACK_CONTROL_H
