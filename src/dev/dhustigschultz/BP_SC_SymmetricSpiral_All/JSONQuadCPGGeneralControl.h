...
#ifndef JSON_QUAD_CPG_GENERAL_CONTROL_H
#define JSON_QUAD_CPG_GENERAL_CONTROL_H

/**
 * @file JSONCPGGeneralControl.h
...
class tgCPGGeneralActuatorControl;
class CPGEquations;
class tgCPGLogger;
 ...
 */
class JSONQuadCPGGeneralControl : public tgObserver<BaseQuadModelLearning>, public tgSubject <JSONQuadCPGGeneralControl>
{
public:
...
struct Config
    ...
    JSONQuadCPGGeneralControl(JSONQuadCPGGeneralControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONQuadCPGGeneralControl();
...
protected:
    ...
    std::vector<tgCPGGeneralActuatorControl*> m_allControllers;
    
    JSONQuadCPGGeneralControl::Config m_config;
