...
#ifndef MOUNTAIN_GOAT_SM_H
#define MOUNTAIN_GOAT_SM_H

/**
 * @file MountainGoatSM.h
...
class MountainGoatSM: public BaseQuadModelLearning 
{
public: 

    MountainGoatSM(int segments, int hips, int legs);

    virtual ~MountainGoatSM();
