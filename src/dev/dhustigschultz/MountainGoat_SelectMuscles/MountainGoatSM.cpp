...
MountainGoatSM::MountainGoatSM(int segments, int hips, int legs) :
...
MountainGoatSM::~MountainGoatSM()
{
}

void MountainGoatSM::addNodesLeg(tgStructure& s, double r){ 
...
void MountainGoatSM::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(1,2,"rod");
    s.addPair(1,3,"rod");
    s.addPair(1,4,"rod");
...
void MountainGoatSM::addNodesHip(tgStructure& s, double r){
...
void MountainGoatSM::addRodsHip(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
}

void MountainGoatSM::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void MountainGoatSM::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatSM::addSegments(tgStructure& goat, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, double r){ 
...
void MountainGoatSM::addMuscles(tgStructure& goat){ 
    ...
    goat.addPair(n7[1], n0[2], tgString("hip front top muscleAct1 seg", 7) + tgString(" seg", 0));
    ...
    goat.addPair(n8[3], n4[1], tgString("afront bottom muscleAct1 seg", 8) + tgString(" seg", 4));
    ...
    goat.addPair(n11[4], n7[3], tgString("outer bicep muscle seg", 11) + tgString(" seg", 7));
    goat.addPair(n11[4], n7[2], tgString("inner bicep muscle seg", 11) + tgString(" seg", 7));
    goat.addPair(n11[4], n1[4], tgString("all left_foreleg front horizontal abdomen connection muscle seg", 11) + tgString(" seg", 1));
    ...
    goat.addPair(n13[4], n9[2], tgString("inner bicep muscle seg", 13) + tgString(" seg", 9));
    goat.addPair(n13[4], n9[3], tgString("outer bicep muscle seg", 13) + tgString(" seg", 9));
    goat.addPair(n13[4], n1[3], tgString("all right_foreleg front horizontal abdomen connection muscle seg", 13) + tgString(" seg", 1));
    ...
    //Left rear leg/hip
    goat.addPair(n12[4], n8[3], tgString("outer thigh muscle seg", 12) + tgString(" seg", 8)); 
    goat.addPair(n12[4], n8[2], tgString("inner thigh muscle seg", 12) + tgString(" seg", 8));

    goat.addPair(n12[4], n3[1],tgString("all left_hindleg rear horizontal abdomen connection muscle seg", 12) + tgString(" seg", 3)); 
    ...
    //Right rear leg/hip
    goat.addPair(n14[4], n10[2], tgString("inner thigh muscle seg", 14) + tgString(" seg", 10)); 
    goat.addPair(n14[4], n10[3], tgString("outer thigh muscle seg", 14) + tgString(" seg", 10));

    goat.addPair(n14[4], n3[2], tgString("all right_hindleg rear horizontal abdomen connection muscle seg", 14) + tgString(" seg", 3)); //all right_hindleg 
    goat.addPair(n14[3], n5[2], tgString("all right_hindleg front abdomen connection muscle3 seg", 14) + tgString(" seg", 5)); //Active
    goat.addPair(n14[2], n5[3], tgString("all right_hindleg rear abdomen connection muscle3 seg", 14) + tgString(" seg", 5)); //Active
    ...
    goat.addPair(n14[4], n10[1], tgString("all right_hindleg central thigh muscle3 seg", 14) + tgString(" seg", 10)); //Active

}

void MountainGoatSM::setup(tgWorld& world)
{
...
void MountainGoatSM::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
