...
int main(int argc, char** argv)
{
    ...
    const int vertebra = 7;
    const int hips = 4;
    const int legs = 4;

    MountainGoatAnchored* const myModel = new MountainGoatAnchored(vertebra, hips, legs);

    MGController* const myHT = new MGController(timestep_physics); 
