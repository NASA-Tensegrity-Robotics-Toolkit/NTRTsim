...
{
    std::cout << "AppMGSingleLegHT" << std::endl;
    ...
    const int vertebra = 3;
    const int hips = 1;
    const int legs = 1;

    MGSingleLeg* const myModel = new MGSingleLeg(vertebra, hips, legs);

    MGSingleLegController* const myHT2 = new MGSingleLegController(timestep_physics); 

    // Add the model to the world
    myModel->attach(myHT2);
