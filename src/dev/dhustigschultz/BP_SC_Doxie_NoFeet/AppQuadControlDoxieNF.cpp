...
/**
 * @file AppQuadControlDoxieNF.cpp
...
#include "AppQuadControlDoxieNF.h"
#include "dev/btietz/JSONTests/tgCPGJSONLogger.h"

AppQuadControlDoxieNF::AppQuadControlDoxieNF(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppQuadControlDoxieNF::setup()
{
    ...
    BigDoxieNoFeet* myModel = new BigDoxieNoFeet(segments, hips, legs, feet);
...
void AppQuadControlDoxieNF::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppQuadControlDoxieNF::getHillyConfig()
{
...
const tgBoxGround::Config AppQuadControlDoxieNF::getBoxConfig()
{
...
tgModel* AppQuadControlDoxieNF::getBlocks()
{
...
tgWorld* AppQuadControlDoxieNF::createWorld()
{
...
tgSimViewGraphics *AppQuadControlDoxieNF::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppQuadControlDoxieNF::createView(tgWorld *world)
{
    return new tgSimView(*world, timestep_physics, timestep_graphics);
}

bool AppQuadControlDoxieNF::run()
{
    if (!bSetup)
    {
        setup();
...
void AppQuadControlDoxieNF::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppQuadControlDoxieNF" << std::endl;
    AppQuadControlDoxieNF app (argc, argv);
