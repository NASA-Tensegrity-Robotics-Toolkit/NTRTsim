...
JSONAOLongControl::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSONAOLongControl::JSONAOLongControl(JSONAOLongControl::Config config,	
                                                std::string args,
...
JSONAOLongControl::~JSONAOLongControl()
{
    delete nn;
}

void JSONAOLongControl::onSetup(BaseQuadModelLearning& subject)
{
...
void JSONAOLongControl::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSONAOLongControl::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
    metrics.clear();
...
void JSONAOLongControl::setupCPGs(BaseQuadModelLearning& subject, array_2D achillesNodeActions, array_4D achillesEdgeActions)
{
...
array_2D JSONAOLongControl::scaleNodeActions (Json::Value actions)
{
...
std::vector<double> JSONAOLongControl::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSONAOLongControl::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSONAOLongControl::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
