...
#ifndef JSON_AO_LONG_CONTROL_H
#define JSON_AO_LONG_CONTROL_H

/**
 * @file JSONAOLongControl.h
 * @brief A controller for the template class BaseQuadModelLearning
 * Trying longer achilles muscles with a passive spine.
...
/**
 * JSONAOLongControl learns the parameters for a CPG system on a
 ...
 */
class JSONAOLongControl : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSONAOLongControl(JSONAOLongControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONAOLongControl();
...
protected:
    ...
    JSONAOLongControl::Config m_config;
...
#endif // JSON_ACHILLES_LONG_CONTROL_H
