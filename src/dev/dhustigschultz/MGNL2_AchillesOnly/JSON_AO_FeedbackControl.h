...
#ifndef JSON_AO_FEEDBACK_CONTROL_H
#define JSON_AO_FEEDBACK_CONTROL_H

/**
 * @file JSON_AO_FeedbackControl.h
 ...
 */
class JSON_AO_FeedbackControl : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSON_AO_FeedbackControl(JSON_AO_FeedbackControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSON_AO_FeedbackControl();
...
protected:
    ...
    JSON_AO_FeedbackControl::Config m_config;
...
#endif // JSON_ACHILLES_FEEDBACK_CONTROL_H
