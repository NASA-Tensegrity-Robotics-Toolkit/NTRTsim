...
#ifndef APP_MGNL2_AO_H
#define APP_MGNL2_AO_H
...
//robot
#include "dev/dhustigschultz/MountainGoatNL2/MountainGoatNL2.h"
...
{
public:
    AppMGNL2_AO(int argc, char** argv);
...
private:
    ...
    JSON_AO_FeedbackControl * myControl;
