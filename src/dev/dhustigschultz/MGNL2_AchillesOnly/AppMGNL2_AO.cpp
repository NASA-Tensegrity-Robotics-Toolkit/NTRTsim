...
#include "AppMGNL2_AO.h"
#include "dev/btietz/JSONTests/tgCPGJSONLogger.h"
#include "helpers/FileHelpers.h"
#include <json/json.h>

AppMGNL2_AO::AppMGNL2_AO(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppMGNL2_AO::setup()
{
    ...
    MountainGoatNL2* myModel = new MountainGoatNL2(segments, hips, legs);
	...
	std::string controlFilename = controlFilePath + suffix;
        ...
        const int numMuscles = 7; //This is being used, instead of numAchillesMuscles (yeah, what was I thinking?) 
	...
	const double ffMax2 = 10.0;
        ...
        JSON_AO_FeedbackControl::Config control_config(segmentSpan, 
                                                    numMuscles,
                                                    numMuscles,
                                                    numParams, 
                                                    segNumber, 
       ...
       myControl =
        new JSON_AO_FeedbackControl(control_config, suffix, lowerPath); //JSON_AO_FeedbackControl * const 
...
void AppMGNL2_AO::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppMGNL2_AO::getHillyConfig()
{
...
const tgBoxGround::Config AppMGNL2_AO::getBoxConfig()
{
...
tgWorld* AppMGNL2_AO::createWorld()
{
...
void AppMGNL2_AO::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppMGNL2_AO" << std::endl;
    AppMGNL2_AO app (argc, argv);
