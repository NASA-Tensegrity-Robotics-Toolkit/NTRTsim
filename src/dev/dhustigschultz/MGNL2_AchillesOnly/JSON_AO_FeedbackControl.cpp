...
/**
 * @file JSON_AO_FeedbackControl.cpp
...
#include "JSON_AO_FeedbackControl.h"
...
JSON_AO_FeedbackControl::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSON_AO_FeedbackControl::JSON_AO_FeedbackControl(JSON_AO_FeedbackControl::Config config,	
                                                std::string args,
...
JSON_AO_FeedbackControl::~JSON_AO_FeedbackControl()
{
    //delete nn;
}

void JSON_AO_FeedbackControl::onSetup(BaseQuadModelLearning& subject)
{
...
void JSON_AO_FeedbackControl::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSON_AO_FeedbackControl::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
    metrics.clear();
...
void JSON_AO_FeedbackControl::setupCPGs(BaseQuadModelLearning& subject, array_2D achillesNodeActions, array_4D achillesEdgeActions)
{
...
array_2D JSON_AO_FeedbackControl::scaleNodeActions (Json::Value actions, double highFreq, double freqFeedbackMax)
{
...
array_4D JSON_AO_FeedbackControl::scaleEdgeActions  
...
std::vector<double> JSON_AO_FeedbackControl::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSON_AO_FeedbackControl::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSON_AO_FeedbackControl::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
