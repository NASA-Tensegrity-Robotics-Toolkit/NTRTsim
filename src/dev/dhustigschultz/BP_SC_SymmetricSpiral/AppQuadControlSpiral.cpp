...
AppQuadControlSpiral::AppQuadControlSpiral(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppQuadControlSpiral::setup()
{
    ...
    BigPuppySymmetricSpiral1* myModel = new BigPuppySymmetricSpiral1(segments, hips, legs, feet);
...
void AppQuadControlSpiral::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppQuadControlSpiral::getHillyConfig()
{
...
const tgBoxGround::Config AppQuadControlSpiral::getBoxConfig()
{
...
tgModel* AppQuadControlSpiral::getBlocks()
{
...
tgWorld* AppQuadControlSpiral::createWorld()
{
...
tgSimViewGraphics *AppQuadControlSpiral::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppQuadControlSpiral::createView(tgWorld *world)
{
    return new tgSimView(*world, timestep_physics, timestep_graphics);
}

bool AppQuadControlSpiral::run()
{
    if (!bSetup)
    {
        setup();
...
void AppQuadControlSpiral::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppQuadControlSpiral" << std::endl;
    AppQuadControlSpiral app (argc, argv);
