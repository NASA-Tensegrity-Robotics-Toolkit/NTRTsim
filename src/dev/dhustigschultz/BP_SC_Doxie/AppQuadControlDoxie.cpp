...
#include "AppQuadControlDoxie.h"
#include "dev/btietz/JSONTests/tgCPGJSONLogger.h"

AppQuadControlDoxie::AppQuadControlDoxie(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppQuadControlDoxie::setup()
{
    ...
    BigDoxie* myModel = new BigDoxie(segments, hips, legs, feet);
...
void AppQuadControlDoxie::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppQuadControlDoxie::getHillyConfig()
{
...
const tgBoxGround::Config AppQuadControlDoxie::getBoxConfig()
{
...
tgModel* AppQuadControlDoxie::getBlocks()
{
...
tgWorld* AppQuadControlDoxie::createWorld()
{
...
tgSimViewGraphics *AppQuadControlDoxie::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppQuadControlDoxie::createView(tgWorld *world)
{
    return new tgSimView(*world, timestep_physics, timestep_graphics);
}

bool AppQuadControlDoxie::run()
{
    if (!bSetup)
    {
        setup();
...
void AppQuadControlDoxie::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppQuadControlDoxie" << std::endl;
    AppQuadControlDoxie app (argc, argv);
