...
#ifndef MOUNTAIN_ANCHORED_H
#define MOUNTAIN_ANCHORED_H

/**
 * @file MountainGoatAnchored.h
...
class MountainGoatAnchored: public BaseQuadModelLearning 
{
public: 

    MountainGoatAnchored(int segments, int hips, int legs);

    virtual ~MountainGoatAnchored();
...
private:
    ...
    */ 
    ...
    // The massless version, for anchoring to floor.
    static void addRodsMasslessLeg(tgStructure& s); 
    ...
    */
    void addSegments(tgStructure& puppy, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, tgStructure& masslessLeg, double r); 
