...
MountainGoatNL::MountainGoatNL(int segments, int hips, int legs) :
...
MountainGoatNL::~MountainGoatNL()
{
}

void MountainGoatNL::addNodesLeg(tgStructure& s, double r){ 
    s.addNode(0,0,0); //0: Center
    s.addNode(r,r,0);  //1: Front Top
    s.addNode(-r,r,0); //2: Back Top
...
void MountainGoatNL::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatNL::addNodesHip(tgStructure& s, double r){
...
void MountainGoatNL::addRodsHip(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
}

void MountainGoatNL::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void MountainGoatNL::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatNL::addSegments(tgStructure& goat, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, double r){ 
...
void MountainGoatNL::addMuscles(tgStructure& goat){ 
...
void MountainGoatNL::setup(tgWorld& world)
{
...
void MountainGoatNL::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
