...
#ifndef MOUNTAIN_GOAT_NL_H
#define MOUNTAIN_GOAT_NL_H

/**
 * @file MountainGoatNL.h
...
class MountainGoatNL: public BaseQuadModelLearning 
{
public: 

    MountainGoatNL(int segments, int hips, int legs);

    virtual ~MountainGoatNL();
