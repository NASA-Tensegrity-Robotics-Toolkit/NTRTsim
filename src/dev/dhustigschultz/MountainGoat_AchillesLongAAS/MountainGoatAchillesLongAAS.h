...
#ifndef MOUNTAIN_GOAT_ACHILLES_LONG_AAS_H
#define MOUNTAIN_GOAT_ACHILLES_LONG_AAS_H

/**
 * @file MountainGoatAchillesLongAAS.h
 * @brief Trying a longer achilles tendon muscle on the MountainGoat.
 * Trying longer lower legs and achilles muscles, with active spine, to see if speed increases.
...
class MountainGoatAchillesLongAAS: public BaseQuadModelLearning 
{
public: 

    MountainGoatAchillesLongAAS(int segments, int hips, int legs);

    virtual ~MountainGoatAchillesLongAAS();
