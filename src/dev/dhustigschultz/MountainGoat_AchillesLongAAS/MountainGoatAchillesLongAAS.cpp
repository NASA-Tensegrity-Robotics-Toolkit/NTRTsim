 ...
 */
 ...
 /**
 * @file MountainGoatAchillesLongAAS.cpp
...
//This application
#include "MountainGoatAchillesLongAAS.h"
...
MountainGoatAchillesLongAAS::MountainGoatAchillesLongAAS(int segments, int hips, int legs) :
...
MountainGoatAchillesLongAAS::~MountainGoatAchillesLongAAS()
{
}

void MountainGoatAchillesLongAAS::addNodesLeg(tgStructure& s, double r){ 
    s.addNode(0,0,0); //0: Bottom Center of lower leg segment
    s.addNode(0,r+5,0);  //1: Center of lower leg segment
    s.addNode(r,r+5,0); //2: Right of lower leg segment
    s.addNode(-r,r+5,0);  //3: Left of lower leg segment
    s.addNode(0,2*r+5-2,0);  //4: Top of lower leg segment
...
void MountainGoatAchillesLongAAS::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod2");
    s.addPair(1,2,"rod2");
    s.addPair(1,3,"rod2");
    s.addPair(1,4,"rod2");
...
void MountainGoatAchillesLongAAS::addNodesHip(tgStructure& s, double r){
...
void MountainGoatAchillesLongAAS::addRodsHip(tgStructure& s){
    s.addPair(4,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchillesLongAAS::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void MountainGoatAchillesLongAAS::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchillesLongAAS::addSegments(tgStructure& goat, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, double r){ 
...
void MountainGoatAchillesLongAAS::addMuscles(tgStructure& goat){ 
...
void MountainGoatAchillesLongAAS::setup(tgWorld& world)
{
...
void MountainGoatAchillesLongAAS::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void MountainGoatAchillesLongAAS::teardown()
{
