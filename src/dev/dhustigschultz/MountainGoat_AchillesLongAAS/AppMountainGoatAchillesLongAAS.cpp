...
/**
 * @file AppMountainGoatAchillesLongAAS.cpp
...
{
    std::cout << "AppMountainGoatAchillesLongAAS" << std::endl;
    ...
    MountainGoatAchillesLongAAS* const myModel = new MountainGoatAchillesLongAAS(segments, hips, legs);
