...
#ifndef MOUNTAIN_GOAT_ACHILLES_SHORT_H
#define MOUNTAIN_GOAT_ACHILLES_SHORT_H

/**
 * @file MountainGoatAchillesShort.h
...
class MountainGoatAchillesShort: public BaseQuadModelLearning 
{
public: 

    MountainGoatAchillesShort(int segments, int hips, int legs);

    virtual ~MountainGoatAchillesShort();
