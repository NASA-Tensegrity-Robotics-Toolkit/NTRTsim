...
/**
 * @file AppMountainGoatAchillesShort.cpp
...
{
    std::cout << "AppMountainGoatAchillesShort" << std::endl;
    ...
    MountainGoatAchillesShort* const myModel = new MountainGoatAchillesShort(segments, hips, legs);
