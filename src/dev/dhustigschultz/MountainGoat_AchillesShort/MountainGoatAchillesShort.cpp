 ...
 */
 ...
 /**
 * @file MountainGoatAchillesShort.cpp
...
//This application
#include "MountainGoatAchillesShort.h"
...
MountainGoatAchillesShort::MountainGoatAchillesShort(int segments, int hips, int legs) :
...
MountainGoatAchillesShort::~MountainGoatAchillesShort()
{
}

void MountainGoatAchillesShort::addNodesLeg(tgStructure& s, double r){ 
...
void MountainGoatAchillesShort::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod2");
    s.addPair(1,2,"rod2");
    s.addPair(1,3,"rod2");
    s.addPair(1,4,"rod2");
...
void MountainGoatAchillesShort::addNodesHip(tgStructure& s, double r){
...
void MountainGoatAchillesShort::addRodsHip(tgStructure& s){
    s.addPair(4,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchillesShort::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void MountainGoatAchillesShort::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchillesShort::addSegments(tgStructure& goat, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, double r){ 
...
void MountainGoatAchillesShort::addMuscles(tgStructure& goat){ 
...
void MountainGoatAchillesShort::setup(tgWorld& world)
{
...
void MountainGoatAchillesShort::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void MountainGoatAchillesShort::teardown()
{
