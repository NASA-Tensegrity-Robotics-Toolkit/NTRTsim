...
#ifndef MOUNTAIN_GOAT_ACHILLES_SHORT_AAS_H
#define MOUNTAIN_GOAT_ACHILLES_SHORT_AAS_H

/**
 * @file MountainGoatAchillesShortAAS.h
 * @brief Trying a shorter achilles tendon muscle on the MountainGoat.
 * Trying shorter lower legs and achilles muscles, to see if speed increases.
...
class MountainGoatAchillesShortAAS: public BaseQuadModelLearning 
{
public: 

    MountainGoatAchillesShortAAS(int segments, int hips, int legs);

    virtual ~MountainGoatAchillesShortAAS();
