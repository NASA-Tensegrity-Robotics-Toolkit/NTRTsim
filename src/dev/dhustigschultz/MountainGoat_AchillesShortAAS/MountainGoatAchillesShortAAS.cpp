 ...
 */
 ...
 /**
 * @file MountainGoatAchillesShortAAS.cpp
 * @brief Implementing Mountain Goat 
 * Trying to implement a shorter achilles tendon muscle.
...
//This application
#include "MountainGoatAchillesShortAAS.h"
...
MountainGoatAchillesShortAAS::MountainGoatAchillesShortAAS(int segments, int hips, int legs) :
...
MountainGoatAchillesShortAAS::~MountainGoatAchillesShortAAS()
{
}

void MountainGoatAchillesShortAAS::addNodesLeg(tgStructure& s, double r){ 
    s.addNode(0,0,0); //0: Bottom Center of lower leg segment
    s.addNode(0,5,0);  //1: Center of lower leg segment
    s.addNode(r,5,0); //2: Right of lower leg segment
    s.addNode(-r,5,0);  //3: Left of lower leg segment
    s.addNode(0,r+5-2,0);  //4: Top of lower leg segment
...
void MountainGoatAchillesShortAAS::addRodsLeg(tgStructure& s){
    s.addPair(0,1,"rod2");
    s.addPair(1,2,"rod2");
    s.addPair(1,3,"rod2");
    s.addPair(1,4,"rod2");
...
void MountainGoatAchillesShortAAS::addNodesHip(tgStructure& s, double r){
...
void MountainGoatAchillesShortAAS::addRodsHip(tgStructure& s){
    s.addPair(4,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchillesShortAAS::addNodesVertebra(tgStructure& s, double r){
    s.addNode(0,0,0); //Node 0 
...
void MountainGoatAchillesShortAAS::addRodsVertebra(tgStructure& s){
    s.addPair(0,1,"rod");
    s.addPair(0,2,"rod");
    s.addPair(0,3,"rod");
    s.addPair(0,4,"rod");
...
void MountainGoatAchillesShortAAS::addSegments(tgStructure& goat, tgStructure& vertebra, tgStructure& hip, tgStructure& leg, double r){ 
    const double offsetDist = r+1; 
    const double offsetDist2 = offsetDist*6; 
    const double offsetDist3 = offsetDist2+2;
    const double yOffset_leg = -(2*r+1-5); 
    const double yOffset_foot = -(2*r+6-5);
...
void MountainGoatAchillesShortAAS::addMuscles(tgStructure& goat){ 
...
void MountainGoatAchillesShortAAS::setup(tgWorld& world)
{
    ...
    const double yOffset_foot = -(2*rod_space-5+6) - 2;
...
void MountainGoatAchillesShortAAS::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void MountainGoatAchillesShortAAS::teardown()
{
