...
#include "AppAOShort.h"
#include "dev/btietz/JSONTests/tgCPGJSONLogger.h"
#include "helpers/FileHelpers.h"
#include <json/json.h>

AppAOShort::AppAOShort(int argc, char** argv)
{
    bSetup = false;
    use_graphics = false;
    add_controller = true;
...
bool AppAOShort::setup()
{
    ...
    MountainGoatAchillesShort* myModel = new MountainGoatAchillesShort(segments, hips, legs);
	...
	const double minH = 1.0;
        ...
        JSONAOShortControl::Config control_config(segmentSpan, 
                                                    numMuscles,
                                                    numMuscles,
                                                    numParams, 
                                                    segNumber, 
       ...
       myControl =
        new JSONAOShortControl(control_config, suffix, lowerPath); //JSONAOShortControl * const 
...
void AppAOShort::handleOptions(int argc, char **argv)
{
...
const tgHillyGround::Config AppAOShort::getHillyConfig()
{
...
const tgBoxGround::Config AppAOShort::getBoxConfig()
{
...
tgWorld* AppAOShort::createWorld()
{
...
tgSimViewGraphics *AppAOShort::createGraphicsView(tgWorld *world)
{
    return new tgSimViewGraphics(*world, timestep_physics, timestep_graphics);
}

tgSimView *AppAOShort::createView(tgWorld *world)
{
...
void AppAOShort::simulate(tgSimulation *simulation)
{
...
{
    std::cout << "AppAOShort" << std::endl;
    AppAOShort app (argc, argv);
