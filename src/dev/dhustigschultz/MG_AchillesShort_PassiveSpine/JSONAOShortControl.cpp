...
JSONAOShortControl::Config::Config(int ss,
                                        int tm,
                                        int om,
                                        int param,
                                        int segnum,
 ...
 */
JSONAOShortControl::JSONAOShortControl(JSONAOShortControl::Config config,	
                                                std::string args,
...
JSONAOShortControl::~JSONAOShortControl()
{
    delete nn;
}

void JSONAOShortControl::onSetup(BaseQuadModelLearning& subject)
{
	...
	P = (PVal.get(j, 0.0)).asDouble();// 150000.0;
	D = (DVal.get(j, 0.0)).asDouble();// 25.0;
...
void JSONAOShortControl::onStep(BaseQuadModelLearning& subject, double dt)
{
    m_updateTime += dt;
    m_totalTime += dt;
...
void JSONAOShortControl::onTeardown(BaseQuadModelLearning& subject)
{
    scores.clear();
    metrics.clear();
...
void JSONAOShortControl::setupCPGs(BaseQuadModelLearning& subject, array_2D achillesNodeActions, array_4D achillesEdgeActions)
{
...
array_2D JSONAOShortControl::scaleNodeActions (Json::Value actions)
{
...
std::vector<double> JSONAOShortControl::getFeedback(BaseQuadModelLearning& subject)
{
    // Placeholder
...
std::vector<double> JSONAOShortControl::getCableState(const tgSpringCableActuator& cable)
{
...
std::vector<double> JSONAOShortControl::transformFeedbackActions(std::vector< std::vector<double> >& actions)
{
	// Placeholder
	std::vector<double> feedback;
