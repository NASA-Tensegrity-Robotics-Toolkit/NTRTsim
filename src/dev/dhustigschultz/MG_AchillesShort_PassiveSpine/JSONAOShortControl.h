...
#ifndef JSON_AO_SHORT_CONTROL_H
#define JSON_AO_SHORT_CONTROL_H

/**
 * @file JSONAOShortControl.h
 * @brief A controller for the template class BaseQuadModelLearning
 * Trying shorter achilles muscles with a passive spine.
...
/**
 * JSONAOShortControl learns the parameters for a CPG system on a
 ...
 */
class JSONAOShortControl : public JSONQuadCPGControl
{
public:
...
struct Config : public JSONQuadCPGControl::Config
    ...
    JSONAOShortControl(JSONAOShortControl::Config config,	
							std::string args,
							std::string resourcePath = "");
    
    virtual ~JSONAOShortControl();
...
protected:
    ...
    JSONAOShortControl::Config m_config;
...
#endif // JSON_ACHILLES_SHORT_CONTROL_H
