...
#ifndef MG_SINGLE_LEG_H
#define MG_SINGLE_LEG_H
...
class MGSingleLeg: public BaseQuadModelLearning 
{
public: 

    MGSingleLeg(int segments, int hips, int legs);
