...
#ifndef LAIKA_TORSION_CONTROLLER_H
#define LAIKA_TORSION_CONTROLLER_H

/**
 * @file LaikaTorsionController.h
 * @brief Contains the definition of class LaikaTorsionController.
 ...
 */
class LaikaTorsionController : public tgObserver<TensegrityModel>, public tgSubject<LaikaTorsionController>
{
public:
	
  /**
   * Construct a LaikaTorsionController.
   ...
   */
  LaikaTorsionController(double startTime, double minLength, double rate,
			    std::vector<std::string> tagsToControl);
    
  /**
   * Nothing to delete, destructor must be virtual
   */
  virtual ~LaikaTorsionController() { }
...
#endif // LAIKA_TORSION_CONTROLLER_H
