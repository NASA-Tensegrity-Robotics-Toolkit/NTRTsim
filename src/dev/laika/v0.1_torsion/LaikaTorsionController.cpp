...
/**
 * @file LaikaTorsionController.cpp
 * @brief Implementation of LaikaTorsionController.
...
LaikaTorsionController::LaikaTorsionController(double startTime,
						     double minLength,
						     double rate,
 ...
 */
void LaikaTorsionController::initializeActuators(TensegrityModel& subject,
						    std::string tag) {
  //DEBUGGING
 ...
 */
void LaikaTorsionController::onSetup(TensegrityModel& subject)
{
...
void LaikaTorsionController::onStep(TensegrityModel& subject, double dt)
{
