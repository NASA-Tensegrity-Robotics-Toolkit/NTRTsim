...
/**
 * @file CombinedSpineControllerBending.cpp
 * @brief Implementation of a controller that pulls in a cable for bending, used with the combined bending + rot vert model.
...
CombinedSpineControllerBending::CombinedSpineControllerBending(double startTime,
						     double minLength,
						     double rate,
 ...
 */
void CombinedSpineControllerBending::initializeActuators(TensegrityModel& subject,
						    std::string tag) {
  //DEBUGGING
...
void CombinedSpineControllerBending::onStep(TensegrityModel& subject, double dt)
{
