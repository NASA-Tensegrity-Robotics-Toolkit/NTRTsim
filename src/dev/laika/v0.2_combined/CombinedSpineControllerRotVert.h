...
#ifndef COMBINED_SPINE_CONTROLLER_ROTVERT_H
#define COMBINED_SPINE_CONTROLLER_ROTVERT_H

/**
 * @file CombinedSpineControllerRotVert.h
 * @brief Contains the definition of class CombinedSpineControllerRotVert.
 ...
 */
class CombinedSpineControllerRotVert : public tgObserver<TensegrityModel>, public tgSubject<CombinedSpineControllerRotVert>
{
public:
	
  /**
   * Construct a CombinedSpineControllerRotVert.
   ...
   */
  CombinedSpineControllerRotVert(double startTime, btVector3 startTorque,
   ...
   */
  virtual ~CombinedSpineControllerRotVert() { }
...
#endif // COMBINED_SPINE_CONTROLLER_ROTVERT_H
