...
#ifndef COMBINED_SPINE_CONTROLLER_BENDING
#define COMBINED_SPINE_CONTROLLER_BENDING

/**
 * @file CombinedSpineControllerBending.h
 * @brief Contains the definition of class CombinedSpineControllerBending.
 ...
 */
class CombinedSpineControllerBending : public tgObserver<TensegrityModel>, public tgSubject<CombinedSpineControllerBending>
{
public:
	
  /**
   * Construct a CombinedSpineControllerBending.
   ...
   */
  CombinedSpineControllerBending(double startTime, double minLength, double rate,
			    std::vector<std::string> tagsToControl);
    
  /**
   * Nothing to delete, destructor must be virtual
   */
  virtual ~CombinedSpineControllerBending() { }
...
#endif // COMBINED_SPINE_CONTROLLER_BENDING
