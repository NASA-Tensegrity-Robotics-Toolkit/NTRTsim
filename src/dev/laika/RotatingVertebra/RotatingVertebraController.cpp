...
/**
 * @file RotatingVertebraController.cpp
 * @brief Implementation of RotatingVertebraController.
...
RotatingVertebraController::RotatingVertebraController(double startTime,
 ...
 */
void RotatingVertebraController::onSetup(TensegrityModel& subject)
{
  std::cout << "Setting up a RotatingVertebraController with tag: "
  ...
  btHingeConstraint* rotHinge =
    new btHingeConstraint(*rodA_rb, *rodB_rb, btVector3(-5, 0, 0),
 ...
 */
void RotatingVertebraController::onStep(TensegrityModel& subject, double dt)
{
