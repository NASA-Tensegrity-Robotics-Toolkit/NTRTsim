...
#ifndef ROTATING_VERTEBRA_CONTROLLER_H
#define ROTATING_VERTEBRA_CONTROLLER_H

/**
 * @file RotatingVertebraController.h
 * @brief Contains the definition of class RotatingVertebraController.
 ...
 */
class RotatingVertebraController : public tgObserver<TensegrityModel>, public tgSubject<RotatingVertebraController>
{
public:
	
  /**
   * Construct a RotatingVertebraController.
   ...
   */
  RotatingVertebraController(double startTime, btVector3 startTorque,
   ...
   */
  virtual ~RotatingVertebraController() { }
...
#endif // ROTATING_VERTEBRA_CONTROLLER_H
