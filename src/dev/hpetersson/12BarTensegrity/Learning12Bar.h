...
#ifndef LEARNING12BAR_H
#define LEARNING12BAR_H

/**
 * @file Learning12Bar.h
 ...
 */
class Learning12Bar : public BaseSpineModelLearning
{
public: 

    Learning12Bar(int segments);

    virtual ~Learning12Bar();
