...
Learning12Bar::Learning12Bar(int segments) :   
    BaseSpineModelLearning(segments) 
{
}

Learning12Bar::~Learning12Bar()
{
}

void Learning12Bar::setup(tgWorld& world)
{
...
void Learning12Bar::step(double dt)
{
