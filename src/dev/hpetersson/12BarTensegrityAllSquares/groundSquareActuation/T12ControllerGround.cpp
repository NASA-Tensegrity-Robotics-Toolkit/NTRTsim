...
T12ControllerGround::T12ControllerGround(T12Model* subject, const double initialLength, double startTime) :
...
void T12ControllerGround::onSetup(T12Model& subject)
{
    double dt = 0.0001;
    srand(3);    
    //groundFace = -1;
...
void T12ControllerGround::onStep(T12Model& subject, double dt)
{
    if (dt <= 0.0) {
...
void T12ControllerGround::onTeardown(T12Model& subject) {
 ...
 */
void T12ControllerGround::applyActions(T12Model& subject, vector< vector <double> > actions)
{
    // DEBUGGING
...
void T12ControllerGround::setPreferredMuscleLengths(T12Model& subject, double dt) {
...
void T12ControllerGround::populateClusters(T12Model& subject) {
    int nMuscles = 36;
    int iMuscle = 0;
...
double T12ControllerGround::displacement(T12Model& subject) {
...
double T12ControllerGround::totalEnergySpent(T12Model& subject) {
...
void T12ControllerGround::getGroundFace(T12Model& subject) {
