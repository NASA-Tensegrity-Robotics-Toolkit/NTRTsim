...
/**
 * @file LengthControllerMultipleSequential.h
 * @brief Contains the definition of class LengthControllerMultipleSequential
...
#ifndef LENGTHCONTROLLERMULTIPLESEQUENTIAL_H
#define LENGTHCONTROLLERMULTIPLESEQUENTIAL_H
 ...
 */
class LengthControllerMultipleSequential : public tgObserver<TensegrityModel>, public tgSubject<LengthControllerMultipleSequential>
{
public:
   ...
   */
  LengthControllerMultipleSequential(double startTime, double minLength, double rate,
			    std::vector<std::string> tagsToControl);
    
  /**
   * Nothing to delete, destructor must be virtual
   */
  virtual ~LengthControllerMultipleSequential() { }
