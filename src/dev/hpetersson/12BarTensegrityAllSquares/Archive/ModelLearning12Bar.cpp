...
ModelLearning12Bar::ModelLearning12Bar(int segments) :   
    BaseSpineModelLearning(segments) 
{
}

ModelLearning12Bar::~ModelLearning12Bar()
{
}

void ModelLearning12Bar::setup(tgWorld& world)
{
...
void ModelLearning12Bar::teardown()
{
...
void ModelLearning12Bar::step(double dt)
{
