...
#include <vector>							/* Change libraries */
...
class tgImpedanceController;  /* Remove all of these and add TensegrityModel and tgBasicActuator */
 ...
 */
class BaseSpineCPGControl : public tgObserver<BaseSpineModelLearning>, public tgSubject <BaseSpineCPGControl> /* Change names */
{
public:
...
struct Config
    ...
    public:
        ...
        // CPG control frequency		/* Remove from here */
        ...
        const double controlLength;    		/* to here */
    };

    BaseSpineCPGControl(BaseSpineCPGControl::Config config,				/* Change name and make sure function */	
							std::string args,		/* takes learning parameters */
    ...
    virtual void onTeardown(BaseSpineModelLearning& subject);		/* Look more into this one */

	const double getCPGValue(std::size_t i) const;		/* Remove */
	
	double getScore() const;				/* Unclear what this is */

			/* Add initActuators in protected */
...
protected:
	...
	/* Add private: lots of parameters */
};
