...
#ifndef ROS_LC_12BAROCTAHEDRON_H
#define ROS_LC_12BAROCTAHEDRON_H
 ...
 */
class ROS_LC_12BarOctahedron : public tgObserver<TensegrityModel>, public tgSubject<ROS_LC_12BarOctahedron>
{
public:
   ...
   */
   ROS_LC_12BarOctahedron(double startTime, double minLength, double rate, std::vector<std::string> tagsToControl);
 
   /**
   * Nothing to delete, destructor must be virtual
   */
   virtual ~ROS_LC_12BarOctahedron() { }
...
#endif // ROS_LC_12BAROCTAHEDRON_H
