...
ROS_LC_12BarOctahedron::ROS_LC_12BarOctahedron(double startTime, 
							double minLength, 
							double rate,
 ...
 */
void ROS_LC_12BarOctahedron::initializeActuators(TensegrityModel& subject, std::string tag) {
 ...
 */
void ROS_LC_12BarOctahedron::onSetup(TensegrityModel& subject)
{
  std::cout << "Setting up the ROS_LC_12BarOctahedron controller." << std::endl;
 ...
 */
void ROS_LC_12BarOctahedron::onStep(TensegrityModel& subject, double dt) {
