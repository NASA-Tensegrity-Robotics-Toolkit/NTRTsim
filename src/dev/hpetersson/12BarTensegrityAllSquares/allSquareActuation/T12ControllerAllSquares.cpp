...
/**
 * @file T12ControllerAllSquares.cpp
...
// This module
#include "T12ControllerAllSquares.h"
// This application
#include "T12Model.h"
// This library
...
T12ControllerAllSquares::T12ControllerAllSquares(T12Model* subject, const double initialLength, double startTime) :
...
void T12ControllerAllSquares::onSetup(T12Model& subject)
{
    double dt = 0.0001;
    srand(3);    
    //groundFace = -1;
...
void T12ControllerAllSquares::onStep(T12Model& subject, double dt)
{
    if (dt <= 0.0) {
...
void T12ControllerAllSquares::onTeardown(T12Model& subject) {
 ...
 */
vector< vector <double> > T12ControllerAllSquares::transformActions(vector< vector <double> > actions1D)
{
 ...
 */
void T12ControllerAllSquares::applyActions(T12Model& subject, vector< vector <double> > actions)
{
    // DEBUGGING
...
void T12ControllerAllSquares::setupAdapter() {
...
void T12ControllerAllSquares::setPreferredMuscleLengths(T12Model& subject, double dt) {
...
void T12ControllerAllSquares::populateClusters(T12Model& subject) {
    int nMuscles = 36;
    int iMuscle = 0;
...
void T12ControllerAllSquares::initializeSineWaves() {
...
double T12ControllerAllSquares::displacement(T12Model& subject) {
...
std::vector<double> T12ControllerAllSquares::readManualParams(int lineNumber, const char* filename) {
    assert(lineNumber > 0);
...
void T12ControllerAllSquares::printSineParams() {
    for (size_t cluster = 0; cluster < squareClusters.size(); cluster++) {
...
void T12ControllerAllSquares::determineFace(bool isSquareFace) {
...
double T12ControllerAllSquares::totalEnergySpent(T12Model& subject) {
...
void T12ControllerAllSquares::getGroundFace(T12Model& subject) {
...
void T12ControllerAllSquares::write2txtFile(double contentDouble, char const* contentString, bool isDouble) {
...
*/
void T12ControllerAllSquares::write2csvFile(double contentDouble, char const* sign, bool isDouble) {
...
void T12ControllerAllSquares::getFileName(void) {
...
void T12ControllerAllSquares::saveData2File(void) { 
...
void T12ControllerAllSquares::clearParams(void) { 
