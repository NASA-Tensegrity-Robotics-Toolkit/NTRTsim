...
/**
 * @file T12ControllerAllSquares.h
 * @brief Contains the definition of class T12ControllerAllSquares.
...
class T12ControllerAllSquares : public tgObserver<T12Model>
{
    public:
        // Note that currently this is calibrated for decimeters.
        T12ControllerAllSquares(T12Model* subject, const double prefLength=5.0, double startTime=3);

        /** Nothing to delete, destructor must be virtual */
        virtual ~T12ControllerAllSquares() { }
