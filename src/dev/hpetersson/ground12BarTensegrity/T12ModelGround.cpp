...
/**
 * @file T12ModelGround.cpp
z * @brief Contains the implementation of class T12ModelGround.
 * $Id$
 */
...
T12ModelGround::T12ModelGround() : tgModel() 
{
}

T12ModelGround::~T12ModelGround()
{
}

void T12ModelGround::addNodes(tgStructure& s)
{
...
void T12ModelGround::addRods(tgStructure& s)
{
    s.addPair( 0,  1, "rod"); // 0
    s.addPair( 2,  3, "rod"); // 1
    s.addPair( 4,  5, "rod"); // 2
...
void T12ModelGround::addMuscles(tgStructure& s)
{
...
void T12ModelGround::setup(tgWorld& world)
{
...
void T12ModelGround::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void T12ModelGround::onVisit(tgModelVisitor& r)
{
    tgModel::onVisit(r);
}

// Return the center of mass of this model
std::vector<double> T12ModelGround::getBallCOM() {
...
std::vector<double> T12ModelGround::getRodCOM(int rodIndex) {
    std::vector <tgRod*> rods = find<tgRod>("rod");
    assert(!rods.empty());
...
std::vector<double> T12ModelGround::getNodePosition(int rodIndex) {
    std::vector <tgRod*> rods = find<tgRod>("rod");
    const tgRod* const rod = rods[rodIndex];
...
const std::vector<tgBasicActuator*>& T12ModelGround::getAllMuscles() const
{
    return allMuscles;
}

const std::vector<tgBasicActuator*>& T12ModelGround::getPassiveMuscles() const
{
    return passiveMuscles;
}

const std::vector<tgBasicActuator*>& T12ModelGround::getActiveMuscles() const
{
    return activeMuscles;
}

const double T12ModelGround::muscleRatio()
{
	return (c.stiffnessA/c.stiffnessB);
	//return 2.5;
}
    
void T12ModelGround::teardown()
{
