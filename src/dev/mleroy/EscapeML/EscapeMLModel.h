...
#ifndef ESCAPE_ML_MODEL_H
#define ESCAPE_ML_MODEL_H

/**
 * @file EscapeMLModel.h
 * @brief Contains the definition of class EscapeMLModel.
 * $Id$
 */
 ...
 */
class EscapeMLModel : public tgSubject<EscapeMLModel>, public tgModel
{
public: 
