...
/**
 * @file EscapeMLModel.cpp
 * @brief Contains the implementation of class EscapeMLModel.
 * $Id$
 */
...
EscapeMLModel::EscapeMLModel() : tgModel() 
{
}

EscapeMLModel::~EscapeMLModel()
{
}

void EscapeMLModel::addNodes(tgStructure& s)
{
...
void EscapeMLModel::addRods(tgStructure& s)
{
    s.addPair( 0,  1, "rod");
    s.addPair( 2,  3, "rod");
    s.addPair( 4,  5, "rod");
...
// 24 muscles in total
void EscapeMLModel::addMuscles(tgStructure& s)
{
...
void EscapeMLModel::setup(tgWorld& world)
{
...
void EscapeMLModel::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void EscapeMLModel::onVisit(tgModelVisitor& r)
{
    tgModel::onVisit(r);
}

const std::vector<tgBasicActuator*>& EscapeMLModel::getAllMuscles() const
{
    return allMuscles;
}
    
void EscapeMLModel::teardown()
{
    notifyTeardown();
    tgModel::teardown();
}
...
std::vector<double> EscapeMLModel::getBallCOM() {   
