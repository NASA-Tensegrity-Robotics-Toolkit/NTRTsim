...
/*
void SecondKneeModel::addNodesB(tgStructure& s,
                            double edge,
                            double width,
                            double height)
{
...
/*
void SecondKneeModel::addRodsB(tgStructure& s)
{
//fibia
	//Bottom
    s.addPair( 0,  1, "rodB");
...
/*
	//Create fixed lower limb
	tgStructure sB;
	addNodesB(sB, c. triangle_length, c.triangle_height, c.Knee_height);
	addRodsB(sB);
	sB.move(btVector3(0,0,0));	
*/    
    const tgRod::Config rodConfigA(c.radius, c.densityA);
    //const tgRod::Config rodConfigB(c. radius,c.densityB);
