...
/**
 * @file ControlTFController.cpp
 * @brief Preferred Length Controller for ControlTFModel
...
ControlTFController::ControlTFController(const double initialLength, double timestep) :
    m_initialLengths(initialLength),
    m_totalTime(0.0),
    dt(timestep) {}

//Fetch all the muscles and set their preferred length
void ControlTFController::onSetup(ControlTFModel& subject) {
	this->m_totalTime=0.0;
    const double gastro_length = 12;
...
void ControlTFController::onStep(ControlTFModel& subject, double dt) {
...
void ControlTFController::setGastroTargetLength(ControlTFModel& subject, double dt) {
...
void ControlTFController::moveAllMotors(ControlTFModel& subject, double dt) {
...
void ControlTFController::updateActions(ControlTFModel& subject, double dt) {
...
vector< vector <double> > ControlTFController::transformActions(vector< vector <double> > actions)
{
	double min=6;
	double max=11;
...
void ControlTFController::applyActions(ControlTFModel& subject, vector< vector <double> > act)
{
