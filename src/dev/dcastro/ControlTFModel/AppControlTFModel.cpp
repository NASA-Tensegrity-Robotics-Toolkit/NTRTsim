...
{
    std::cout << "AppControlTFModelTest" << std::endl;
    ...
    // simulation
    ControlTFModel* const myModel = new ControlTFModel();

     // Fifth, select the controller to use 
    ControlTFController* const pTC = new ControlTFController(12, timestep_physics);
