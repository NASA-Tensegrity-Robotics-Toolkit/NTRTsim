...
//femur
    ...
    // top front
    tetra.addNode(0, (height*2)+2, 2 , "sphere"); // 13
    // top front left
    tetra.addNode(1, (height*2)+2, 1, "sphere");// 14
    //top back left
    tetra.addNode(1, (height*2)+2, -1, "sphere"); //15
    // top back 
    tetra.addNode(0, (height*2)+2, -2, "sphere"); // 16
    // top back right
...
//Femur Section
	...
	tetra.addPair(7, 17, "Semimebranosus");//Semimembranosus
	tetra.addPair(6, 15, "Bicep Femoris");//Bicep Femoris Long Head
...
void ControlTFModel::setup(tgWorld& world)
{
    ...
    spec.addBuilder("GastLateral", new tgBasicActuatorInfo(muscleConfig));
    spec.addBuilder("GastMedial", new tgBasicActuatorInfo(muscleConfig));
    spec.addBuilder("Semimebranosus", new tgBasicActuatorInfo(muscleConfig));
...
const std::vector<tgBasicActuator*>& ControlTFModel::getAllActuators() const
{
    return allActuators;
}
