...
#ifndef CONTROL_TF_MODEL_H
#define CONTROL_TF_MODEL_H

/**
 * @file ControlTFModel.h
 ...
 */
class ControlTFModel : public tgSubject<ControlTFModel>, public tgModel
{
public:
