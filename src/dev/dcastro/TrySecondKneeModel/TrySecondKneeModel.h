...
#ifndef TRY_SECOND_KNEE_MODEL_H
#define TRY_SECOND_KNEE_MODEL_H

/**
 * @file SecondKneeModel.h
 ...
 */
class TrySecondKneeModel : public tgSubject<TrySecondKneeModel>, public tgModel
{
public:
