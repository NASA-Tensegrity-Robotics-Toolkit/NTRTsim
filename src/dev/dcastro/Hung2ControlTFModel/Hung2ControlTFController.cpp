...
/**
 * @file Hung2ControlTFController.cpp
 * @brief Preferred Length Controller for Hung2ControlTFModel
...
void Hung2ControlTFController::onStep(Hung2ControlTFModel& subject, double dt) {
...
void Hung2ControlTFController::moveAllMotors(Hung2ControlTFModel& subject, double dt) {
...
void Hung2ControlTFController::updateActions(Hung2ControlTFModel& subject, double dt) {
...
void Hung2ControlTFController::applyActions(Hung2ControlTFModel& subject, vector< vector <double> > act)
{
