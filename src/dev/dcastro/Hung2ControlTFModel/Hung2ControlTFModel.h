...
#ifndef Hung2CONTROL_TF_MODEL_H
#define Hung2CONTROL_TF_MODEL_H

/**
 * @file Hung2ControlTFModel.h
 ...
 */
class Hung2ControlTFModel : public tgSubject<Hung2ControlTFModel>, public tgModel
{
public:
