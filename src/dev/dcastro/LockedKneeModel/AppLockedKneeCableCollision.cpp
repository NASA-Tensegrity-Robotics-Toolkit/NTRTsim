...
/**
 * @file AppLockedKnee.cpp
 * @brief Contains the definition function main() for LockedKnee
 * application.
...
//#include "LockedKneeCableCollisionBendingController.h"
// This library
...
{
    std::cout << "AppLockedKneeCableCollision" << std::endl;
    ...
    LockedKneeModelCableCollision* myModel = new LockedKneeModelCableCollision();
    ...
    /*
    LockedKneeBendingController* const pTC = new LockedKneeCableCollisionBendingController();
    myModel->attach(pTC);
    */
