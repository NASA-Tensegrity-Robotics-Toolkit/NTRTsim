...
#ifndef LOCKED_KNEE_MODEL_CABLE_COLLISION_H
#define LOCKED_KNEE_MODEL_CABLE_COLLISION_H
b
/**
 * @file LockedKneeModelCableCollision.h
 * @brief Contains the definition of class LockedKneeModel
...
class LockedKneeModelCableCollision: public BaseSpineModelLearning
{
public:

  LockedKneeModelCableCollision();
  virtual ~LockedKneeModelCableCollision();
