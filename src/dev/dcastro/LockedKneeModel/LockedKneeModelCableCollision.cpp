...
/**
 * @file LockedKneeModel.cpp
 * @brief Contains the implementation of class LockedkneeModel
 * @author Brian Tietz, Drew Sabelhaus, Michael Fanton, ChanWoo Yang
 * $Id$
 */

// This module
#include "LockedKneeModelCableCollision.h"
// This library
...
//m_segments(segments),
//tgModel()
LockedKneeModelCableCollision::LockedKneeModelCableCollision() :
...
namespace
{
  ...
  void addNodes(tgStructure& tetra, double edge, double height)
  {
    ...
    // bottom front
    tetra.addNode(0, 0, height/1.5, "sphere"); // 3
    // bottom back
    tetra.addNode(0, 0, -height/1.5, "sphere"); //4
    //top origin
    ...
    // bottom front
    tetra.addNode(0, height, height/1.5, "sphere"); // 8
    // bottom back
    tetra.addNode(0, height, -height/1.5, "sphere"); //9


//humerus
	//bottom origin
    tetra.addNode(0, height+2, 0, "sphere"); //10
    // bottom right
    tetra.addNode(-edge/1.5, height+2, 0, "sphere"); // 11
    // bottom left
    tetra.addNode( edge/1.5, height+2, 0, "sphere"); // 12
    // bottom front
    tetra.addNode(0, height+2, height/2, "sphere"); // 13
    // bottom back
    tetra.addNode(0, height+2, -height/2, "sphere");// 14
	//top origin
    tetra.addNode(0, height*2, 0, "sphere"); //15
    // top right
    tetra.addNode(-edge/1.5, height*2, 0, "sphere"); // 16
    // top left
    tetra.addNode( edge/1.5, height*2, 0, "sphere"); // 17
    // top front
    tetra.addNode(0, height*2, height/2, "sphere"); // 18
    // top back
    tetra.addNode(0, height*2, -height/2, "sphere");//19
    /*
    // right
  ...
  */
  ...
  //tibia and fibia (Cross Beams)
    ...
    // bottom front
    tetra.addNode(0, 0, height/1.5); // 3
    // bottom back
    tetra.addNode(0, 0, -height/1.5); //4
    //top origin
    ...
    // bottom front
    tetra.addNode(0, height, height/1.5); // 8
    // bottom back
    tetra.addNode(0, height, -height/1.5); //9
...
*/
  ...
  void addMuscles(tgStructure& tetra)//changed from snake
  {
  //Tibia and Fibia
...
/*
  void mapMuscles(LockedKneeModelCableCollision::MuscleMap& muscleMap,
 ...
 **************************************/
void LockedKneeModelCableCollision::setup(tgWorld& world)
{
...
void LockedKneeModelCableCollision::teardown()
{
  BaseSpineModelLearning::teardown();
}

void LockedKneeModelCableCollision::step(double dt)
{
    if (dt < 0.0)
    {
