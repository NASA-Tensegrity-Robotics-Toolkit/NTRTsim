...
void ThirdTFModel::addNodes(tgStructure& tetra,
                            double edge,
                            double width,
                            double height)
{
...
void ThirdTFModel::addNodesB(tgStructure& tetra,
                            double edge,
                            double width,
                            double height)
{
...
void ThirdTFModel::addPairs(tgStructure& tetra)
{
//fibula and tibia
...
void ThirdTFModel::addPairsB(tgStructure& tetra)
{
//Holding Structure
	//Bottom
...
void ThirdTFModel::addMuscles(tgStructure& tetra)
{
...
void ThirdTFModel::setup(tgWorld& world)
{
...
void ThirdTFModel::step(double dt)
{
    // Precondition
    if (dt <= 0.0)
    {
...
void ThirdTFModel::onVisit(tgModelVisitor& r)
{
    // Example: m_rod->getRigidBody()->dosomething()...
    tgModel::onVisit(r);
}

const std::vector<tgSpringCableActuator*>& ThirdTFModel::getAllActuators() const
{
    return allActuators;
}

void ThirdTFModel::teardown()
{
    notifyTeardown();
    tgModel::teardown();
}
