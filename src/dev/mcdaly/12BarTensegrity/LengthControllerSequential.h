...
/**
 * @file LengthControllerSequential.h
 * @brief Contains the definition of class LengthControllerSequential
 ...
 */
class LengthControllerSequential : public tgObserver<TensegrityModel>, public tgSubject<LengthControllerSequential>
{
public:
   ...
   */
  LengthControllerSequential(double startTime, double minLength, double rate,
			    std::vector<std::string> tagsToControl);
    
  /**
   * Nothing to delete, destructor must be virtual
   */
  virtual ~LengthControllerSequential() { }
