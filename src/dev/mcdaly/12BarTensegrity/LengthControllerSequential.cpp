...
/**
 * @file LengthControllerSequential.cpp
 * @brief Implementation of LengthControllerSequential.h
...
// This module
#include "LengthControllerSequential.h"
// This application
...
LengthControllerSequential::LengthControllerSequential(double startTime,
					   double minLength,
					   double rate,
 ...
 */
void LengthControllerSequential::initializeActuators(TensegrityModel& subject,
					       std::string tag) {
  //DEBUGGING
 ...
 */
void LengthControllerSequential::onSetup(TensegrityModel& subject)
{
  std::cout << "Setting up the LengthControllerSequential controller." << std::endl;
...
void LengthControllerSequential::onStep(TensegrityModel& subject, double dt)
{
