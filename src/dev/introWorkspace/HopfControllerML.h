...
public:
  ...
  virtual void hopfController(TensegrityModel& subject, double *hopfArray, double dt, double m_timePassed, double *dxdt, double *ddxddt, int firstCable, int lastCable, double initRestLengths, int hopfSelector);//, double *hopf_x, double hopf_y, double hopf_omega, double hopf_mu);
  ...
  virtual void write_hopf(double *hopfArray, const double t, char *filenamehopf, char *filenamecable, char *filenamespeed);
