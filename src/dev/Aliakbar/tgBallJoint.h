...
#ifndef TG_BALL_JOINT_H
#define TG_BALL_JOINT_H
...
class tgBallJoint: public tgSubject<tgBallJoint>, public tgModel
{
public: 
     ...
     * @param[in] constraint The btPoint2PointConstraint object that this controls and logs.
     * Set up in tgBallJointInfo.cpp
...
private:
    ...
    btPoint2PointConstraint* m_balljoint;
