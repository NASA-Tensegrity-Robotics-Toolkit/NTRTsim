...
/**
 * @file SBModel.h
 * @brief Contains the definition of class SBModel.
 * $Id$
 */
...
/**
 * Class that creates the six strut SB model created at UC Berkeley using tgcreator
 */
class SBModel : public tgSubject<SBModel>, public tgModel
{
public: 
...
private:
     ...
     * @param[in] s A tgStructure that we're building into
     */
    static void addSB(tgStructure& s);
