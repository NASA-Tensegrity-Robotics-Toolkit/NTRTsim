...
#ifndef SIX_BAR_MINI_MODEL_H
#define SIX_BAR_MINI_MODEL_H

/**
 * @file sixBarMiniModel.h
 ...
 */
class sixBarMiniModel : public tgSubject<sixBarMiniModel>, public tgModel 
{
	public:
	...
	private:
	     ...
	     * rod length parameter in the Config struct in sixBarMiniModel.cpp to 
