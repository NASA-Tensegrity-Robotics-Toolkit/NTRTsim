...
/**
* @file ICRA2015_pair_ordering_test.cpp
...
// This application
#include "dev/btietz/TetraSpineStatic/TetraSpineStaticModel_hf_pair_ordering.h"
...
namespace {
	...
	TEST_F(HardwareTest, ICRA2015Static) {
				...
				// same model as TetraSpineStaticModel_hf, except with pairs defined in a different order
				TetraSpineStaticModel_hf_pair_ordering* myModel =
				  new TetraSpineStaticModel_hf_pair_ordering(segments);
